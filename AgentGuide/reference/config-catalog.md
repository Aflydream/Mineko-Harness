...
Depends on: [`agentCore`](../../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#aflydreammnh-tools)
...
Depends on: [`LocalConfig`](#aflydreammnh-bash-local)
...
Depends on: [`LocalConfig`](#aflydreammnh-fs-local)
...
Source: [`packages/llm/llm-pi-ai/src/config.ts:168`](../../packages/llm/llm-pi-ai/src/config.ts)
...
Depends on: [`LocalConfig`](#aflydreammnh-pwsh-local)
...
Source: [`packages/subagent/subagent-mnh-sdk/src/index.ts:29`](../../packages/subagent/subagent-mnh-sdk/src/index.ts)
...
- `@aflydream/mnh-api-gateway` — requires `typert` ([`packages/api/gateway/src/index.ts`](../../packages/api/gateway/src/index.ts))
...
- `@aflydream/mnh-client-modules` — requires `loader` ([`packages/client/modules/src/index.ts`](../../packages/client/modules/src/index.ts))
...
- `@aflydream/mnh-client-ui-deliverables` — requires `systemPrompt` ([`packages/client/ui-deliverables/src/index.ts`](../../packages/client/ui-deliverables/src/index.ts))
...
- `@aflydream/mnh-command-compact` — requires `commands` · `compaction` ([`packages/compaction/command-compact/src/index.ts`](../../packages/compaction/command-compact/src/index.ts))
- `@aflydream/mnh-command-feedback` — requires `commands` ([`packages/feedback/command-feedback/src/index.ts`](../../packages/feedback/command-feedback/src/index.ts))
- `@aflydream/mnh-command-goal` — requires `commands` · `goals` ([`packages/goal/command-goal/src/index.ts`](../../packages/goal/command-goal/src/index.ts))
...
- `@aflydream/mnh-fs-e2b` — requires `e2b` ([`packages/e2b/fs-e2b/src/index.ts`](../../packages/e2b/fs-e2b/src/index.ts))
...
- `@aflydream/mnh-goal-round-driver` — requires `agents` · `goals` · `sessions` ([`packages/goal/goal-round-driver/src/index.ts`](../../packages/goal/goal-round-driver/src/index.ts))
- `@aflydream/mnh-host-desktop-bridge` ([`packages/host/desktop-bridge/src/index.ts`](../../packages/host/desktop-bridge/src/index.ts))
- `@aflydream/mnh-host-directory-picker-auto` — requires `webServer` · `loader` ([`packages/host/directory-picker-auto/src/index.ts`](../../packages/host/directory-picker-auto/src/index.ts))
...
- `@aflydream/mnh-host-plugin-inventory` — requires `loader` ([`packages/host/plugin-inventory/src/index.ts`](../../packages/host/plugin-inventory/src/index.ts))
...
- `@aflydream/mnh-schedule` — requires `agents` · `sessions` · `tools` · `sessionPersistence` ([`packages/schedule/schedule/src/index.ts`](../../packages/schedule/schedule/src/index.ts))
- `@aflydream/mnh-session` ([`packages/core/session/src/index.ts`](../../packages/core/session/src/index.ts))
- `@aflydream/mnh-session-checkpoint-policy` — requires `llm` · `sessionPersistence` · `sessions` · `tools` ([`packages/session/session-checkpoint-policy/src/index.ts`](../../packages/session/session-checkpoint-policy/src/index.ts))
- `@aflydream/mnh-session-log-export` — requires `commands` ([`packages/session-query/session-log-export/src/index.ts`](../../packages/session-query/session-log-export/src/index.ts))
...
- `@aflydream/mnh-session-stats` — requires `sessionProjections` ([`packages/session/session-stats/src/index.ts`](../../packages/session/session-stats/src/index.ts))
- `@aflydream/mnh-skill-badge` — requires `skills` ([`packages/skill/skill-badge/src/index.ts`](../../packages/skill/skill-badge/src/index.ts))
...
- `@aflydream/mnh-tool-ask-user` — requires `tools` · `userQuestions` ([`packages/interaction/tool-ask-user/src/index.ts`](../../packages/interaction/tool-ask-user/src/index.ts))
- `@aflydream/mnh-tool-call-timeout-policy` — requires `tools` ([`packages/guard/timeout-policy/src/index.ts`](../../packages/guard/timeout-policy/src/index.ts))
- `@aflydream/mnh-tool-cordis` — requires `tools` · `systemPrompt` · `dynamicCordisRunner` · `cordisInspect` ([`packages/extensions/tool-cordis/src/index.ts`](../../packages/extensions/tool-cordis/src/index.ts))
- `@aflydream/mnh-tool-subagent-control` — requires `tools` · `subagents` ([`packages/subagent/tool-subagent-control/src/index.ts`](../../packages/subagent/tool-subagent-control/src/index.ts))
...
- `@aflydream/mnh-workspace` — requires `storageDomain` · `sessionPersistence` ([`packages/workspace/workspace/src/index.ts`](../../packages/workspace/workspace/src/index.ts))
...
- `@aflydream/mnh-attachment` — abstract `AttachmentStore` ([`packages/attachment/attachment/src/index.ts`](../../packages/attachment/attachment/src/index.ts))
- `@aflydream/mnh-code-runtime` — abstract `CodeRuntime` ([`packages/code-runtime/code-runtime/src/index.ts`](../../packages/code-runtime/code-runtime/src/index.ts))
- `@aflydream/mnh-compaction` — abstract `CompactionEngine` ([`packages/compaction/compaction/src/index.ts`](../../packages/compaction/compaction/src/index.ts))
- `@aflydream/mnh-credentials` — abstract `CredentialProvider` ([`packages/credentials/credentials/src/index.ts`](../../packages/credentials/credentials/src/index.ts))
- `@aflydream/mnh-fs` — abstract `FileSystem` ([`packages/fs/fs/src/index.ts`](../../packages/fs/fs/src/index.ts))
- `@aflydream/mnh-host-directory-picker` — abstract `DirectoryPicker` ([`packages/host/directory-picker/src/index.ts`](../../packages/host/directory-picker/src/index.ts))
- `@aflydream/mnh-jobs` — abstract `JobRegistry` ([`packages/jobs/jobs/src/index.ts`](../../packages/jobs/jobs/src/index.ts))
- `@aflydream/mnh-sandbox` — abstract `SandboxProvider` ([`packages/sandbox/sandbox/src/index.ts`](../../packages/sandbox/sandbox/src/index.ts))
- `@aflydream/mnh-session-persistence` — abstract `SessionPersistence` ([`packages/session/session-persistence/src/index.ts`](../../packages/session/session-persistence/src/index.ts))
- `@aflydream/mnh-session-query` — abstract `SessionQueryEngine` ([`packages/session-query/session-query/src/index.ts`](../../packages/session-query/session-query/src/index.ts))
- `@aflydream/mnh-settings` — abstract `SettingsProvider` ([`packages/settings/settings/src/index.ts`](../../packages/settings/settings/src/index.ts))
- `@aflydream/mnh-shell` — abstract `ShellExecutor` ([`packages/shell/shell/src/index.ts`](../../packages/shell/shell/src/index.ts))
- `@aflydream/mnh-spill` — abstract `SpillStore` ([`packages/spill/spill/src/index.ts`](../../packages/spill/spill/src/index.ts))
- `@aflydream/mnh-subprocess` — abstract `SubprocessRuntime` ([`packages/subprocess/subprocess/src/index.ts`](../../packages/subprocess/subprocess/src/index.ts))
- `@aflydream/mnh-workflow` — abstract `WorkflowEngine` ([`packages/workflow/workflow/src/index.ts`](../../packages/workflow/workflow/src/index.ts))
