<!-- 英文源文件由 scripts/gen-config-catalog.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `pnpm run gen-config-catalog` 更新英文，再更新本文件并运行 `pnpm run verify-translation-pairing --write AgentGuide/reference/config-catalog.md` 重新记录配对。 -->
...
<a id="aflydreammnh-acp-demo"></a>

## `@aflydream/mnh-acp-demo`
...
export interface Config {
  ...
  persona?: string
  /** Explicit model-facing tool order (the system-prompt plugin's `toolOrder` config; see mnh-system-prompt). */
  toolOrder?: string[]
...
依赖：[`agentCore`](../../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#aflydreammnh-tools)

来源：[`packages/examples/acp-demo/src/index.ts:39`](../../packages/examples/acp-demo/src/index.ts)

<a id="aflydreammnh-agent-default-model"></a>

## `@aflydream/mnh-agent-default-model`
...
<a id="aflydreammnh-agent-instructions"></a>

## `@aflydream/mnh-agent-instructions`

```ts config-catalog
/** User-facing workspace instruction loader configuration. */
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$MNH_HOME` or `~/.mnh`. */
  mnhHome?: string
...
<a id="aflydreammnh-agent-loop"></a>

## `@aflydream/mnh-agent-loop`
...
<a id="aflydreammnh-agent-presets"></a>

## `@aflydream/mnh-agent-presets`
...
<a id="aflydreammnh-agent-spine-demo"></a>

## `@aflydream/mnh-agent-spine-demo`
 ...
 * `mnhHome` to bash environment and local skill discovery, `sessionTitle` to
 ...
 */
export interface Config {
  /** The agent-loop `agents` list (see mnh-agent-loop's `Config`). */
  ...
  /** The deployment persona (see mnh-system-prompt's `Config`). */
  persona?: SystemPromptConfig['persona']
  /** The explicit model-facing tool order (see mnh-system-prompt's `Config`). */
...
依赖：[`AgentLoopConfig`](#aflydreammnh-agent-loop) · [`GoalDomainConfig`](#aflydreammnh-goal) · [`InvariantConfig`](#aflydreammnh-invariants) · [`JobsConfig`](#aflydreammnh-jobs-local) · [`SessionTitleConfig`](#aflydreammnh-session-title) · [`SkillFileSystem`](../../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#aflydreammnh-skill) · [`SystemPromptConfig`](#aflydreammnh-system-prompt) · [`toolBash`](../../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#aflydreammnh-tools) · [`toolSkill`](../../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../../packages/context/agent-instructions/src/index.ts)

来源：[`packages/examples/agent-spine-demo/src/index.ts:92`](../../packages/examples/agent-spine-demo/src/index.ts)

<a id="aflydreammnh-agent-tool-presentation"></a>

## `@aflydream/mnh-agent-tool-presentation`
...
<a id="aflydreammnh-attachment-local"></a>

## `@aflydream/mnh-attachment-local`

```ts config-catalog
/** Local attachment backend configuration. */
export interface Config {
  /** Explicit harness home; omitted follows `MNH_HOME`, then `~/.mnh`. */
  mnhHome?: string
...
<a id="aflydreammnh-bash-local"></a>

## `@aflydream/mnh-bash-local`
...
<a id="aflydreammnh-bash-sandbox"></a>

## `@aflydream/mnh-bash-sandbox`
 ...
 * on `ctx.sandboxPolicy` (`@aflydream/mnh-sandbox-policy`), which resolves
...
依赖：[`LocalConfig`](#aflydreammnh-bash-local)

来源：[`packages/shell/bash-sandbox/src/index.ts:35`](../../packages/shell/bash-sandbox/src/index.ts)

<a id="aflydreammnh-client-connection"></a>

## `@aflydream/mnh-client-connection`
...
export interface ConnectionConfig {
   ...
   * by (the mnh CLI derives the machine's LAN IP literals itself). An entry
...
<a id="aflydreammnh-client-hmr"></a>

## `@aflydream/mnh-client-hmr`
...
<a id="aflydreammnh-code-runtime-worker-thread"></a>

## `@aflydream/mnh-code-runtime-worker-thread`
...
<a id="aflydreammnh-compaction-basic"></a>

## `@aflydream/mnh-compaction-basic`
...
<a id="aflydreammnh-compaction-tool-result-pruner"></a>

## `@aflydream/mnh-compaction-tool-result-pruner`
...
<a id="aflydreammnh-cordis-host-runner"></a>

## `@aflydream/mnh-cordis-host-runner`
...
<a id="aflydreammnh-credentials-local"></a>

## `@aflydream/mnh-credentials-local`
...
export interface Config {
  ...
  path?: string
  /** Harness home used when `path` is omitted; defaults to `$MNH_HOME` or `~/.mnh`. */
  mnhHome?: string
...
<a id="aflydreammnh-fs-local"></a>

## `@aflydream/mnh-fs-local`
...
<a id="aflydreammnh-fs-sandbox"></a>

## `@aflydream/mnh-fs-sandbox`
...
<a id="aflydreammnh-headless"></a>

## `@aflydream/mnh-headless`
...
<a id="aflydreammnh-hooks-claude-code"></a>

## `@aflydream/mnh-hooks-claude-code`
...
export interface Config {
  ...
  /** Maximum number of extra model steps a blocking Stop hook may request per turn. */
...
<a id="aflydreammnh-hooks-codex"></a>

## `@aflydream/mnh-hooks-codex`
...
<a id="aflydreammnh-host-apiproxy"></a>

## `@aflydream/mnh-host-apiproxy`
...
<a id="aflydreammnh-host-directory-picker-browse"></a>

## `@aflydream/mnh-host-directory-picker-browse`
...
<a id="aflydreammnh-host-frontend-static"></a>

## `@aflydream/mnh-host-frontend-static`
...
<a id="aflydreammnh-host-webserver"></a>

## `@aflydream/mnh-host-webserver`
...
<a id="aflydreammnh-invariants"></a>

## `@aflydream/mnh-invariants`
...
<a id="aflydreammnh-jobs-local"></a>

## `@aflydream/mnh-jobs-local`
...
<a id="aflydreammnh-llm-deepseek"></a>

## `@aflydream/mnh-llm-deepseek`
...
<a id="aflydreammnh-llm-pi-ai"></a>

## `@aflydream/mnh-llm-pi-ai`
...
<a id="aflydreammnh-llm-replay"></a>

## `@aflydream/mnh-llm-replay`

需要：`llm`

```ts config-catalog
/** Plugin config: the {@link ReplayConfig} inputs, each defaulting to its `MNH_SNAPSHOT_*` env var in `apply`. */
export interface Config {
  /** Override the fixture path; defaults to `$MNH_SNAPSHOT_FILE`. */
  file?: string
  /** Override the sidecar path; defaults to `$MNH_SNAPSHOT_OVERRIDE`. */
  overrideFile?: string
  /**
   * Override the child-log paths; defaults to `$MNH_SNAPSHOT_CHILD_FILES` (a
...
<a id="aflydreammnh-llm-retry"></a>

## `@aflydream/mnh-llm-retry`
...
<a id="aflydreammnh-lsp-stdio"></a>

## `@aflydream/mnh-lsp-stdio`
...
<a id="aflydreammnh-mcp-client"></a>

## `@aflydream/mnh-mcp-client`
...
<a id="aflydreammnh-message-feedback"></a>

## `@aflydream/mnh-message-feedback`
...
<a id="aflydreammnh-permission-presets"></a>

## `@aflydream/mnh-permission-presets`
...
<a id="aflydreammnh-persona"></a>

## `@aflydream/mnh-persona`
...
<a id="aflydreammnh-plan-mode"></a>

## `@aflydream/mnh-plan-mode`
...
<a id="aflydreammnh-pwsh-local"></a>

## `@aflydream/mnh-pwsh-local`
...
<a id="aflydreammnh-pwsh-sandbox"></a>

## `@aflydream/mnh-pwsh-sandbox`
...
依赖：[`LocalConfig`](#aflydreammnh-pwsh-local)

来源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../../packages/shell/pwsh-sandbox/src/index.ts)

<a id="aflydreammnh-repeat-tool-reminder"></a>

## `@aflydream/mnh-repeat-tool-reminder`
...
<a id="aflydreammnh-sandbox-local"></a>

## `@aflydream/mnh-sandbox-local`
...
<a id="aflydreammnh-sandbox-policy"></a>

## `@aflydream/mnh-sandbox-policy`
...
<a id="aflydreammnh-sdk-jsonrpc-server"></a>

## `@aflydream/mnh-sdk-jsonrpc-server`
...
<a id="aflydreammnh-session-persistence-jsonl"></a>

## `@aflydream/mnh-session-persistence-jsonl`
...
<a id="aflydreammnh-session-persistence-sqlite"></a>

## `@aflydream/mnh-session-persistence-sqlite`
...
<a id="aflydreammnh-session-projection-cache"></a>

## `@aflydream/mnh-session-projection-cache`
...
<a id="aflydreammnh-session-query-sqlite"></a>

## `@aflydream/mnh-session-query-sqlite`
...
<a id="aflydreammnh-session-reference"></a>

## `@aflydream/mnh-session-reference`
...
<a id="aflydreammnh-session-telemetry-otel"></a>

## `@aflydream/mnh-session-telemetry-otel`
 ...
 * and one MNH-owned shutdown bound. Uploading modes validate their endpoint
...
<a id="aflydreammnh-session-title"></a>

## `@aflydream/mnh-session-title`
...
<a id="aflydreammnh-session-title-all-prompts-llm"></a>

## `@aflydream/mnh-session-title-all-prompts-llm`
...
<a id="aflydreammnh-session-title-first-prompt-llm"></a>

## `@aflydream/mnh-session-title-first-prompt-llm`
...
<a id="aflydreammnh-settings-file"></a>

## `@aflydream/mnh-settings-file`
...
<a id="aflydreammnh-shell-env"></a>

## `@aflydream/mnh-shell-env`
...
<a id="aflydreammnh-skill-filesystem"></a>

## `@aflydream/mnh-skill-filesystem`
...
export interface Config {
  ...
  /** Bundled skill root; defaults to `$MNH_BUNDLED_SKILL_DIR` when default roots are included, otherwise mounts none. */
...
<a id="aflydreammnh-spill-local"></a>

## `@aflydream/mnh-spill-local`
...
<a id="aflydreammnh-spill-policy"></a>

## `@aflydream/mnh-spill-policy`
...
<a id="aflydreammnh-storage-domain"></a>

## `@aflydream/mnh-storage-domain`
...
<a id="aflydreammnh-storage-json"></a>

## `@aflydream/mnh-storage-json`
...
<a id="aflydreammnh-storage-sqlite"></a>

## `@aflydream/mnh-storage-sqlite`
...
<a id="aflydreammnh-subagent-acp"></a>

## `@aflydream/mnh-subagent-acp`
...
<a id="aflydreammnh-subagent-claude-code"></a>

## `@aflydream/mnh-subagent-claude-code`
...
<a id="aflydreammnh-subagent-codex"></a>

## `@aflydream/mnh-subagent-codex`
...
<a id="aflydreammnh-subagent-fork-in-process"></a>

## `@aflydream/mnh-subagent-fork-in-process`
...
<a id="aflydreammnh-subagent-mnh-sdk"></a>

## `@aflydream/mnh-subagent-mnh-sdk`
...
export interface Config {
  /** Provider name on `ctx.subagents` (default `mnh-sdk`). */
  providerName: string
  ...
  /**
   * Extra environment variables for the child process — e.g. the child
   * runtime's own `DEEPSEEK_API_KEY`, or `MNH_CORDIS_CONFIG` naming its
...
来源：[`packages/subagent/subagent-mnh-sdk/src/index.ts:29`](../../packages/subagent/subagent-mnh-sdk/src/index.ts)

<a id="aflydreammnh-subagent-spawn-in-process"></a>

## `@aflydream/mnh-subagent-spawn-in-process`
...
<a id="aflydreammnh-subprocess-e2b"></a>

## `@aflydream/mnh-subprocess-e2b`
...
<a id="aflydreammnh-system-prompt"></a>

## `@aflydream/mnh-system-prompt`
...
<a id="aflydreammnh-terminal-bash"></a>

## `@aflydream/mnh-terminal-bash`
...
<a id="aflydreammnh-time-context"></a>

## `@aflydream/mnh-time-context`
...
<a id="aflydreammnh-tmux-context"></a>

## `@aflydream/mnh-tmux-context`
...
<a id="aflydreammnh-token-meter"></a>

## `@aflydream/mnh-token-meter`
...
<a id="aflydreammnh-tool-bash"></a>

## `@aflydream/mnh-tool-bash`
...
<a id="aflydreammnh-tool-bash-persistent"></a>

## `@aflydream/mnh-tool-bash-persistent`
...
<a id="aflydreammnh-tool-fs"></a>

## `@aflydream/mnh-tool-fs`
...
<a id="aflydreammnh-tool-fs-search"></a>

## `@aflydream/mnh-tool-fs-search`
...
export interface Config {
   ...
   * `@aflydream/mnh-tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
```
...
<a id="aflydreammnh-tool-goal"></a>

## `@aflydream/mnh-tool-goal`
...
<a id="aflydreammnh-tool-jobs"></a>

## `@aflydream/mnh-tool-jobs`
...
<a id="aflydreammnh-tool-lsp"></a>

## `@aflydream/mnh-tool-lsp`
...
<a id="aflydreammnh-tool-pwsh"></a>

## `@aflydream/mnh-tool-pwsh`
...
<a id="aflydreammnh-tool-ralph"></a>

## `@aflydream/mnh-tool-ralph`
...
<a id="aflydreammnh-tool-session-query"></a>

## `@aflydream/mnh-tool-session-query`
...
<a id="aflydreammnh-tool-skill"></a>

## `@aflydream/mnh-tool-skill`
...
<a id="aflydreammnh-tool-str-replace-editor"></a>

## `@aflydream/mnh-tool-str-replace-editor`
...
<a id="aflydreammnh-tool-subagent"></a>

## `@aflydream/mnh-tool-subagent`
...
<a id="aflydreammnh-tool-subagent-report"></a>

## `@aflydream/mnh-tool-subagent-report`
...
<a id="aflydreammnh-tool-terminal"></a>

## `@aflydream/mnh-tool-terminal`
...
<a id="aflydreammnh-tool-todo"></a>

## `@aflydream/mnh-tool-todo`
...
<a id="aflydreammnh-tool-web"></a>

## `@aflydream/mnh-tool-web`
...
<a id="aflydreammnh-tool-workflow"></a>

## `@aflydream/mnh-tool-workflow`
...
<a id="aflydreammnh-typert-loader"></a>

## `@aflydream/mnh-typert-loader`
...
<a id="aflydreammnh-user-approval"></a>

## `@aflydream/mnh-user-approval`
...
<a id="aflydreammnh-web-app"></a>

## `@aflydream/mnh-web-app`
...
export interface Config {
   ...
   * section and the `MNH_WEB_URL` bash variable). A one-shot non-interactive
...
<a id="aflydreammnh-web-fetch-http"></a>

## `@aflydream/mnh-web-fetch-http`
...
<a id="aflydreammnh-web-search-deepseek"></a>

## `@aflydream/mnh-web-search-deepseek`
...
<a id="aflydreammnh-web-search-exa"></a>

## `@aflydream/mnh-web-search-exa`
...
<a id="aflydreammnh-web-search-perplexity"></a>

## `@aflydream/mnh-web-search-perplexity`
...
<a id="aflydreammnh-workflow-worker-thread"></a>

## `@aflydream/mnh-workflow-worker-thread`
...
- `@aflydream/mnh-agent`（[`packages/core/agent/src/index.ts`](../../packages/core/agent/src/index.ts)）
- `@aflydream/mnh-api-gateway` — 需要 `typert`（[`packages/api/gateway/src/index.ts`](../../packages/api/gateway/src/index.ts)）
- `@aflydream/mnh-api-remotes`（[`packages/api/remotes/src/index.ts`](../../packages/api/remotes/src/index.ts)）
- `@aflydream/mnh-client-locale`（[`packages/client/locale/src/index.ts`](../../packages/client/locale/src/index.ts)）
- `@aflydream/mnh-client-modules` — 需要 `webServer` · `loader`（[`packages/client/modules/src/index.ts`](../../packages/client/modules/src/index.ts)）
- `@aflydream/mnh-client-runtime`（[`packages/client/runtime/src/index.ts`](../../packages/client/runtime/src/index.ts)）
- `@aflydream/mnh-client-ui-agent-preset`（[`packages/client/ui-agent-preset/src/index.ts`](../../packages/client/ui-agent-preset/src/index.ts)）
- `@aflydream/mnh-client-ui-commands`（[`packages/client/ui-commands/src/index.ts`](../../packages/client/ui-commands/src/index.ts)）
- `@aflydream/mnh-client-ui-conversation`（[`packages/client/ui-conversation/src/index.ts`](../../packages/client/ui-conversation/src/index.ts)）
- `@aflydream/mnh-client-ui-cordis`（[`packages/extensions/ui-cordis/src/index.ts`](../../packages/extensions/ui-cordis/src/index.ts)）
- `@aflydream/mnh-client-ui-deliverables` — 需要 `systemPrompt`（[`packages/client/ui-deliverables/src/index.ts`](../../packages/client/ui-deliverables/src/index.ts)）
- `@aflydream/mnh-client-ui-directory-picker-browse`（[`packages/client/ui-directory-picker-browse/src/index.ts`](../../packages/client/ui-directory-picker-browse/src/index.ts)）
- `@aflydream/mnh-client-ui-directory-picker-native`（[`packages/client/ui-directory-picker-native/src/index.ts`](../../packages/client/ui-directory-picker-native/src/index.ts)）
- `@aflydream/mnh-client-ui-goal`（[`packages/client/ui-goal/src/index.ts`](../../packages/client/ui-goal/src/index.ts)）
- `@aflydream/mnh-client-ui-input-trigger`（[`packages/client/ui-input-trigger/src/index.ts`](../../packages/client/ui-input-trigger/src/index.ts)）
- `@aflydream/mnh-client-ui-jobs`（[`packages/client/ui-jobs/src/index.ts`](../../packages/client/ui-jobs/src/index.ts)）
- `@aflydream/mnh-client-ui-layout`（[`packages/client/ui-layout/src/index.ts`](../../packages/client/ui-layout/src/index.ts)）
- `@aflydream/mnh-client-ui-message-feedback`（[`packages/client/ui-message-feedback/src/index.ts`](../../packages/client/ui-message-feedback/src/index.ts)）
- `@aflydream/mnh-client-ui-model-selection`（[`packages/client/ui-model-selection/src/index.ts`](../../packages/client/ui-model-selection/src/index.ts)）
- `@aflydream/mnh-client-ui-permission-presets`（[`packages/client/ui-permission-presets/src/index.ts`](../../packages/client/ui-permission-presets/src/index.ts)）
- `@aflydream/mnh-client-ui-plan`（[`packages/client/ui-plan/src/index.ts`](../../packages/client/ui-plan/src/index.ts)）
- `@aflydream/mnh-client-ui-settings`（[`packages/client/ui-settings/src/index.ts`](../../packages/client/ui-settings/src/index.ts)）
- `@aflydream/mnh-client-ui-settings-general`（[`packages/client/ui-settings-general/src/index.ts`](../../packages/client/ui-settings-general/src/index.ts)）
- `@aflydream/mnh-client-ui-settings-models`（[`packages/client/ui-settings-models/src/index.ts`](../../packages/client/ui-settings-models/src/index.ts)）
- `@aflydream/mnh-client-ui-settings-plugin-inventory`（[`packages/client/ui-settings-plugin-inventory/src/index.ts`](../../packages/client/ui-settings-plugin-inventory/src/index.ts)）
- `@aflydream/mnh-client-ui-settings-plugins`（[`packages/client/ui-settings-plugins/src/index.ts`](../../packages/client/ui-settings-plugins/src/index.ts)）
- `@aflydream/mnh-client-ui-sidebar`（[`packages/client/ui-sidebar/src/index.ts`](../../packages/client/ui-sidebar/src/index.ts)）
- `@aflydream/mnh-client-ui-skill`（[`packages/client/ui-skill/src/index.ts`](../../packages/client/ui-skill/src/index.ts)）
- `@aflydream/mnh-client-ui-subagent`（[`packages/client/ui-subagent/src/index.ts`](../../packages/client/ui-subagent/src/index.ts)）
- `@aflydream/mnh-client-ui-theme`（[`packages/client/ui-theme/src/index.ts`](../../packages/client/ui-theme/src/index.ts)）
- `@aflydream/mnh-client-ui-tool`（[`packages/client/ui-tool/src/index.ts`](../../packages/client/ui-tool/src/index.ts)）
- `@aflydream/mnh-client-ui-trajectory`（[`packages/client/ui-trajectory/src/index.ts`](../../packages/client/ui-trajectory/src/index.ts)）
- `@aflydream/mnh-client-ui-user-questions`（[`packages/client/ui-user-questions/src/index.ts`](../../packages/client/ui-user-questions/src/index.ts)）
- `@aflydream/mnh-client-ui-workflow-run`（[`packages/client/ui-workflow-run/src/index.ts`](../../packages/client/ui-workflow-run/src/index.ts)）
- `@aflydream/mnh-client-ui-workspace`（[`packages/client/ui-workspace/src/index.ts`](../../packages/client/ui-workspace/src/index.ts)）
- `@aflydream/mnh-command-compact` — 需要 `commands` · `compact`（[`packages/compaction/command-compact/src/index.ts`](../../packages/compaction/command-compact/src/index.ts)）
- `@aflydream/mnh-command-feedback` — 需要 `commands`（[`packages/feedback/command-feedback/src/index.ts`](../../packages/feedback/command-feedback/src/index.ts)）
- `@aflydream/mnh-command-goal` — 需要 `commands` · `goals`（[`packages/goal/command-goal/src/index.ts`](../../packages/goal/command-goal/src/index.ts)）
- `@aflydream/mnh-commands`（[`packages/interaction/commands/src/index.ts`](../../packages/interaction/commands/src/index.ts)）
- `@aflydream/mnh-cordis-client-runner`（[`packages/extensions/cordis-client-runner/src/index.ts`](../../packages/extensions/cordis-client-runner/src/index.ts)）
- `@aflydream/mnh-fs-e2b` — 需要 `e2b`（[`packages/e2b/fs-e2b/src/index.ts`](../../packages/e2b/fs-e2b/src/index.ts)）
- `@aflydream/mnh-fs-observation-policy`（[`packages/fs/fs-observation-policy/src/index.ts`](../../packages/fs/fs-observation-policy/src/index.ts)）
- `@aflydream/mnh-goal-round-driver` — 需要 `agents` · `goals` · `sessions`（[`packages/goal/goal-round-driver/src/index.ts`](../../packages/goal/goal-round-driver/src/index.ts)）
- `@aflydream/mnh-host-desktop-bridge`（[`packages/host/desktop-bridge/src/index.ts`](../../packages/host/desktop-bridge/src/index.ts)）
- `@aflydream/mnh-host-directory-picker-auto` — 需要 `webServer` · `loader`（[`packages/host/directory-picker-auto/src/index.ts`](../../packages/host/directory-picker-auto/src/index.ts)）
- `@aflydream/mnh-host-directory-picker-native`（[`packages/host/directory-picker-native/src/index.ts`](../../packages/host/directory-picker-native/src/index.ts)）
- `@aflydream/mnh-host-plugin-inventory` — 需要 `loader`（[`packages/host/plugin-inventory/src/index.ts`](../../packages/host/plugin-inventory/src/index.ts)）
- `@aflydream/mnh-llm`（[`packages/llm/llm/src/index.ts`](../../packages/llm/llm/src/index.ts)）
- `@aflydream/mnh-lsp`（[`packages/lsp/lsp/src/index.ts`](../../packages/lsp/lsp/src/index.ts)）
- `@aflydream/mnh-schedule` — 需要 `agents` · `sessions` · `tools` · `sessionPersistence`（[`packages/schedule/schedule/src/index.ts`](../../packages/schedule/schedule/src/index.ts)）
- `@aflydream/mnh-session`（[`packages/core/session/src/index.ts`](../../packages/core/session/src/index.ts)）
- `@aflydream/mnh-session-checkpoint-policy` — 需要 `llm` · `sessionPersistence` · `sessions` · `tools`（[`packages/session/session-checkpoint-policy/src/index.ts`](../../packages/session/session-checkpoint-policy/src/index.ts)）
- `@aflydream/mnh-session-log-export` — 需要 `commands`（[`packages/session-query/session-log-export/src/index.ts`](../../packages/session-query/session-log-export/src/index.ts)）
- `@aflydream/mnh-session-projection`（[`packages/session/session-projection/src/index.ts`](../../packages/session/session-projection/src/index.ts)）
- `@aflydream/mnh-session-stats` — 需要 `sessionProjections`（[`packages/session/session-stats/src/index.ts`](../../packages/session/session-stats/src/index.ts)）
- `@aflydream/mnh-skill-badge` — 需要 `skills`（[`packages/skill/skill-badge/src/index.ts`](../../packages/skill/skill-badge/src/index.ts)）
- `@aflydream/mnh-storage`（[`packages/storage/storage/src/index.ts`](../../packages/storage/storage/src/index.ts)）
- `@aflydream/mnh-subagent`（[`packages/subagent/subagent/src/index.ts`](../../packages/subagent/subagent/src/index.ts)）
- `@aflydream/mnh-subprocess-local`（[`packages/subprocess/subprocess-local/src/index.ts`](../../packages/subprocess/subprocess-local/src/index.ts)）
- `@aflydream/mnh-terminal`（[`packages/terminal/terminal/src/index.ts`](../../packages/terminal/terminal/src/index.ts)）
- `@aflydream/mnh-tool-ask-user` — 需要 `tools` · `userInteraction`（[`packages/interaction/tool-ask-user/src/index.ts`](../../packages/interaction/tool-ask-user/src/index.ts)）
- `@aflydream/mnh-tool-call-timeout-policy` — 需要 `tools`（[`packages/guard/timeout-policy/src/index.ts`](../../packages/guard/timeout-policy/src/index.ts)）
- `@aflydream/mnh-tool-cordis` — 需要 `tools` · `systemPrompt` · `dynamicCordisRunner` · `cordisInspect`（[`packages/extensions/tool-cordis/src/index.ts`](../../packages/extensions/tool-cordis/src/index.ts)）
- `@aflydream/mnh-tool-subagent-control` — 需要 `tools` · `subagents`（[`packages/subagent/tool-subagent-control/src/index.ts`](../../packages/subagent/tool-subagent-control/src/index.ts)）
- `@aflydream/mnh-user-questions`（[`packages/interaction/user-questions/src/index.ts`](../../packages/interaction/user-questions/src/index.ts)）
- `@aflydream/mnh-workspace` — 需要 `storageDomain` · `sessionPersistence`（[`packages/workspace/workspace/src/index.ts`](../../packages/workspace/workspace/src/index.ts)）

## Seam 包（不可直接加载）

抽象服务类——部署时应改为加载具体的实现包（参见[能力 seam](../architecture.md)）。

- `@aflydream/mnh-attachment` — 抽象 `AttachmentStore`（[`packages/attachment/attachment/src/index.ts`](../../packages/attachment/attachment/src/index.ts)）
- `@aflydream/mnh-code-runtime` — 抽象 `CodeRuntime`（[`packages/code-runtime/code-runtime/src/index.ts`](../../packages/code-runtime/code-runtime/src/index.ts)）
- `@aflydream/mnh-compaction` — 抽象 `CompactionEngine`（[`packages/compaction/compaction/src/index.ts`](../../packages/compaction/compaction/src/index.ts)）
- `@aflydream/mnh-credentials` — 抽象 `Credentials`（[`packages/credentials/credentials/src/index.ts`](../../packages/credentials/credentials/src/index.ts)）
- `@aflydream/mnh-fs` — 抽象 `FileSystem`（[`packages/fs/fs/src/index.ts`](../../packages/fs/fs/src/index.ts)）
- `@aflydream/mnh-host-directory-picker` — 抽象 `DirectoryPicker`（[`packages/host/directory-picker/src/index.ts`](../../packages/host/directory-picker/src/index.ts)）
- `@aflydream/mnh-jobs` — 抽象 `JobRegistry`（[`packages/jobs/jobs/src/index.ts`](../../packages/jobs/jobs/src/index.ts)）
- `@aflydream/mnh-sandbox` — 抽象 `SandboxProvider`（[`packages/sandbox/sandbox/src/index.ts`](../../packages/sandbox/sandbox/src/index.ts)）
- `@aflydream/mnh-session-persistence` — 抽象 `SessionPersistence`（[`packages/session/session-persistence/src/index.ts`](../../packages/session/session-persistence/src/index.ts)）
- `@aflydream/mnh-session-query` — 抽象 `SessionQueryEngine`（[`packages/session-query/session-query/src/index.ts`](../../packages/session-query/session-query/src/index.ts)）
- `@aflydream/mnh-settings` — 抽象 `Settings`（[`packages/settings/settings/src/index.ts`](../../packages/settings/settings/src/index.ts)）
- `@aflydream/mnh-shell` — 抽象 `ShellExecutor`（[`packages/shell/shell/src/index.ts`](../../packages/shell/shell/src/index.ts)）
- `@aflydream/mnh-spill` — 抽象 `SpillStore`（[`packages/spill/spill/src/index.ts`](../../packages/spill/spill/src/index.ts)）
- `@aflydream/mnh-subprocess` — 抽象 `SubprocessRuntime`（[`packages/subprocess/subprocess/src/index.ts`](../../packages/subprocess/subprocess/src/index.ts)）
- `@aflydream/mnh-workflow` — 抽象 `WorkflowEngine`（[`packages/workflow/workflow/src/index.ts`](../../packages/workflow/workflow/src/index.ts)）
## 库包（无插件入口）

由其他包作为库导入；`cordis.yml` 无法加载它们。

- `@aflydream/mnh-acp-snapshot`（[`packages/test-support/acp-snapshot/src/index.ts`](../../packages/test-support/acp-snapshot/src/index.ts)）
- `@aflydream/mnh-agent-loop-testkit`（[`packages/test-support/agent-loop-testkit/src/index.ts`](../../packages/test-support/agent-loop-testkit/src/index.ts)）
- `@aflydream/mnh-anonymous-user-id`（[`packages/identity/anonymous-user-id/src/index.ts`](../../packages/identity/anonymous-user-id/src/index.ts)）
- `@aflydream/mnh-app-boot`（[`packages/boot/app-boot/src/index.ts`](../../packages/boot/app-boot/src/index.ts)）
- `@aflydream/mnh-atomic-write`（[`packages/util/atomic-write/src/index.ts`](../../packages/util/atomic-write/src/index.ts)）
- `@aflydream/mnh-base`（[`packages/bundle/base/src/index.ts`](../../packages/bundle/base/src/index.ts)）
- `@aflydream/mnh-brand`（[`packages/util/brand/src/index.ts`](../../packages/util/brand/src/index.ts)）
- `@aflydream/mnh-client-schema-form`（[`packages/client/schema-form/src/index.ts`](../../packages/client/schema-form/src/index.ts)）
- `@aflydream/mnh-client-test-runtime`（[`packages/test-support/client-runtime/src/index.ts`](../../packages/test-support/client-runtime/src/index.ts)）
- `@aflydream/mnh-client-ui-attachment`（[`packages/client/ui-attachment/src/index.ts`](../../packages/client/ui-attachment/src/index.ts)）
- `@aflydream/mnh-client-ui-primitives`（[`packages/client/ui-primitives/src/index.ts`](../../packages/client/ui-primitives/src/index.ts)）
- `@aflydream/mnh-client-ui-slots`（[`packages/client/ui-slots/src/index.ts`](../../packages/client/ui-slots/src/index.ts)）
- `@aflydream/mnh-client-web`（[`packages/client/web/src/index.ts`](../../packages/client/web/src/index.ts)）
- `@aflydream/mnh-client-web-react`（[`packages/client/web-react/src/index.ts`](../../packages/client/web-react/src/index.ts)）
- `@aflydream/mnh-cmdline`（[`packages/boot/cmdline/src/index.ts`](../../packages/boot/cmdline/src/index.ts)）
- `@aflydream/mnh-desktop-app`（[`packages/bundle/desktop-app/src/index.ts`](../../packages/bundle/desktop-app/src/index.ts)）
- `@aflydream/mnh-home-paths`（[`packages/util/home-paths/src/index.ts`](../../packages/util/home-paths/src/index.ts)）
- `@aflydream/mnh-hook-protocol`（[`packages/hooks/hook-protocol/src/index.ts`](../../packages/hooks/hook-protocol/src/index.ts)）
- `@aflydream/mnh-launch-environment`（[`packages/util/launch-environment/src/index.ts`](../../packages/util/launch-environment/src/index.ts)）
- `@aflydream/mnh-llm-mock-server`（[`packages/test-support/llm-mock-server/src/index.ts`](../../packages/test-support/llm-mock-server/src/index.ts)）
- `@aflydream/mnh-loader-smoke`（[`packages/test-support/loader-smoke/src/index.ts`](../../packages/test-support/loader-smoke/src/index.ts)）
- `@aflydream/mnh-native-command`（[`packages/util/native-command/src/index.ts`](../../packages/util/native-command/src/index.ts)）
- `@aflydream/mnh-output-retention`（[`packages/util/output-retention/src/index.ts`](../../packages/util/output-retention/src/index.ts)）
- `@aflydream/mnh-sandbox-windows-acl`（[`packages/sandbox/sandbox-windows-acl/src/index.ts`](../../packages/sandbox/sandbox-windows-acl/src/index.ts)）
- `@aflydream/mnh-scope`（[`packages/core/scope/src/index.ts`](../../packages/core/scope/src/index.ts)）
- `@aflydream/mnh-sdk-client`（[`packages/sdk/client/src/index.ts`](../../packages/sdk/client/src/index.ts)）
- `@aflydream/mnh-sdk-jsonrpc-demo`（[`packages/examples/jsonrpc-demo/src/index.ts`](../../packages/examples/jsonrpc-demo/src/index.ts)）
- `@aflydream/mnh-sdk-protocol`（[`packages/sdk/protocol/src/index.ts`](../../packages/sdk/protocol/src/index.ts)）
- `@aflydream/mnh-session-telemetry`（[`packages/session/session-telemetry/src/index.ts`](../../packages/session/session-telemetry/src/index.ts)）
- `@aflydream/mnh-session-title-llm`（[`packages/session/session-title-llm/src/index.ts`](../../packages/session/session-title-llm/src/index.ts)）
- `@aflydream/mnh-subagent-in-process-driver`（[`packages/subagent/subagent-in-process-driver/src/index.ts`](../../packages/subagent/subagent-in-process-driver/src/index.ts)）
- `@aflydream/mnh-timeout`（[`packages/util/timeout/src/index.ts`](../../packages/util/timeout/src/index.ts)）
- `@aflydream/mnh-typert-generator`（[`packages/typert/generator/src/index.ts`](../../packages/typert/generator/src/index.ts)）
- `@aflydream/mnh-typert-protocol`（[`packages/typert/protocol/src/index.ts`](../../packages/typert/protocol/src/index.ts)）
- `@aflydream/mnh-typert-registry`（[`packages/typert/registry/src/index.ts`](../../packages/typert/registry/src/index.ts)）
