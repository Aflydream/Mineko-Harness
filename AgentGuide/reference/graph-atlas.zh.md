<!-- 英文源文件由 scripts/gen-doc-graphs.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `pnpm run gen-doc-graphs` 更新英文，再更新本文件并运行 `pnpm run verify-translation-pairing --write AgentGuide/reference/graph-atlas.md` 重新记录配对。 -->
...
本索引背后的流程决策记录在[文档图 Agent Note](../architecture.md)中。
...
| [mnh 共享基础组合](../../apps/cli/composition.md) | `hybrid generated` |
