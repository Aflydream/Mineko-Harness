...
The human-command registry service from [`mnh-commands`](../../../packages/interaction/commands). Interactive adapters use it to discover and directly execute plugin-owned commands for an exact agent without creating a model message. The [command Agent Note](../../conventions.md) owns dispatch and lifecycle rationale; the [package README](../../../packages/interaction/commands/README.md) owns composition and limitations.
