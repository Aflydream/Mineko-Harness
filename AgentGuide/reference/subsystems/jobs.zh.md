...
长时间运行的生产方、`ctx.jobs` 与任务控制命令共用的类型。[运行时 Agent Note](../../architecture.md) 负责设计；本页记录 [`packages/jobs/jobs/src/types.ts`](../../../packages/jobs/jobs/src/types.ts) 中的确切字段和变体。
