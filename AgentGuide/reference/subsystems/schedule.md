...
Schedule owns durable reminders that return to the original live Session as ordinary later conversation turns. The [durable Schedule Agent Note](../../conventions.md) owns the persistence and lifecycle decisions, [conversational delivery](../../conventions.md) owns the no-receipt boundary, the [explicit time-zone boundary](../../conventions.md) owns browser-local interpretation, and [bounded fixed-rate Schedule](../../conventions.md) owns recurrence. This page records the durable and model-facing shapes from [`packages/schedule/schedule/src/types.ts`](../../../packages/schedule/schedule/src/types.ts); the [package README](../../../packages/schedule/schedule/README.md) owns composition, tool behavior, and the exact reminder framing.
