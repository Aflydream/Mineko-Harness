...
Types shared by generated Remote artifacts, the Host Gateway, and consumer API assemblies. The [Typert Gateway Agent Note](../../architecture.md) owns the architecture and transport decisions; this page records the literal public contracts from [`mnh-typert-protocol`](../../../packages/typert/protocol/src/types.ts) and [`mnh-api-gateway`](../../../packages/api/gateway/src/types.ts).
