...
import { parseSessionLog } from '@aflydream/mnh-llm-replay'
import type { SessionEvent, SessionId } from '@aflydream/mnh-session'
import type {} from '@aflydream/mnh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@aflydream/mnh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@aflydream/mnh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@aflydream/mnh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@aflydream/mnh-skill-filesystem"}\n',
