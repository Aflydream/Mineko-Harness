...
// in the temp workspace) all run; the model adapter is mnh-llm-replay (keyless)
...
// Record: MNH_SNAPSHOT=record rewrites session.jsonl, then a keyless
// MNH_SNAPSHOT=refresh regenerates ui.expected.md.
