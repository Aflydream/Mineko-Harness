...
/** OS-assigned free port, released before use (the spawned `mnh web` needs a concrete --port). */
 ...
 * `conversationContextKey` in mnh-client-runtime; a drift between them makes
