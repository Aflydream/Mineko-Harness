...
Follow the [repository testing policy](../../AgentGuide/reference/testing.md), which owns adapter coverage, real-provider checks, and published-entry requirements.
