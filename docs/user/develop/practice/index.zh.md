...
- **Service Definition** (`mnh-shell`)：定义 Cordis 服务以及 Bash 请求和结果类型
- **Service Provider** (`mnh-bash-local`)：在本地计算机上执行命令
- **Consumer** (`mnh-tool-bash`)：将该能力公开为模型可调用的工具
...
当前内置系列及其包链接由[能力 seam 参考](../../../../AgentGuide/reference/capability-seams.md)负责。
