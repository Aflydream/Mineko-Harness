...
This overlay opts one `mnh web` process into Schedule reminders without changing the shipped default Web composition:

```sh
mnh web --patch examples/web-schedule/cordis.yml
```
