...
User-facing docs are English. Keep the README focused on install, usage, and support status; durable design decisions belong in docs/ alongside the code, and the current implementation belongs in [AgentGuide/reference/architecture.md](AgentGuide/reference/architecture.md).
