...
import type { Agent, AgentOptions, AgentSetup } from '@aflydream/mnh-agent'
...
import type {} from '@aflydream/mnh-typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a mnh-session-persistence backend)')
  }
