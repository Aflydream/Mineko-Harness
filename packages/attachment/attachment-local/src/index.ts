/** Local durable attachment backend rooted below `MNH_HOME`. @module @aflydream/mnh-attachment-local */
...
export class LocalAttachmentStore extends AttachmentStore {
  ...
  constructor(ctx: Context, config: Config) {
    super(ctx)
    this.root = resolve(join(resolveMnhHome(config.mnhHome), 'attachments', 'v1'))
