/** Package-owned invariant companion for `@aflydream/mnh-attachment-local`. @module @aflydream/mnh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@aflydream/mnh-invariants'

const PACKAGE_NAME = '@aflydream/mnh-attachment-local'
