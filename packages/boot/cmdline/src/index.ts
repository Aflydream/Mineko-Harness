/**
 * @aflydream/mnh-cmdline — the command line a mnh launcher hands to the app
 * it boots.
 *
 ...
 * `port: !!js ctx.webStartup.port ?? 3088` — so a flag beats the value written
 * beside it. No row has launcher-level command-line status.
 * @module @aflydream/mnh-cmdline
 */
 ...
 * verbatim and in argv order. `mnh --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
