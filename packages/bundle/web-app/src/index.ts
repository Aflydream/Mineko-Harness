...
function webSurfacePrompt(webUrl: string): string {
  ...
  return `You are interacting with the user through the MiNeko Herness Web GUI at ${webUrl}. `
  ...
  if (config.surfaceContext) {
    ...
    ctx.inject(['shellEnv'], (runtimeCtx) => {
      runtimeCtx.shellEnv.register({
        name: 'web-runtime',
        variables: {
          [MNH_WEB_URL]: { description: 'Canonical local URL of the MiNeko Herness Web GUI serving this session.' },
        },
