/**
 * Package-owned invariant companion for `@aflydream/mnh-client-connection`.
 * @module @aflydream/mnh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-connection'
