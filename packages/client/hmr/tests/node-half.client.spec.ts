...
import type { WebBootGraph, ClientModuleRegistry } from '@aflydream/mnh-client-modules'
import type { WebRoute, WebServer } from '@aflydream/mnh-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'mnh-hmr-')) })
