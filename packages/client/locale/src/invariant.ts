/**
 * Package-owned invariant companion for `@aflydream/mnh-client-locale`.
 * @module @aflydream/mnh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-locale'
