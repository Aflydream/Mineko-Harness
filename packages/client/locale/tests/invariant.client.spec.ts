...
import { apply as nodeApply } from '@aflydream/mnh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@aflydream/mnh-client-locale/client'
import * as LocaleInvariant from '@aflydream/mnh-client-locale/invariant'
