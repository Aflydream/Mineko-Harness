...
import { stubSettingsScope, type StubSettingsScope } from '@aflydream/mnh-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@aflydream/mnh-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (mnh-client-test-runtime): they need the shapes
