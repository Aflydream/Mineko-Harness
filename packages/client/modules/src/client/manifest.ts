 ...
 * `__MNH_BOOT__` wire types, the boot-manifest parser, and the boundaries around
...
export function parseBootManifest(wire: unknown): BootManifest {
  if (typeof wire !== 'object' || wire === null) {
    throw new Error('client-modules: window.__MNH_BOOT__ is missing or not an object')
  }
...
export interface MnhWindow {
   ...
   */
  __MNH_MODULES__?: ClientModuleSystem
}
