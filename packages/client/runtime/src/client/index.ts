...
import type { ConnectionHandle, SessionId } from '@aflydream/mnh-api-remotes/client'
...
import type { TypertContext } from '@aflydream/mnh-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@aflydream/mnh-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@aflydream/mnh-session/surface'
...
// mnh-client-ui-settings (see that package's settings-scope.ts).
export type {
...
export type { SubagentAddress, JobView } from '@aflydream/mnh-client-connection/client'
...
export { displayFailureMessage, isContextWindowFailure } from './sessions/failure-display.ts'
export type {
...
// page, AgentGuide/reference/subsystems/session-projection.md): host-computed
...
export type { SessionId } from '@aflydream/mnh-client-connection/client'
...
declare module '@aflydream/mnh-client-ui-slots' {
  /**
