 ...
 * session-projection subsystem page, AgentGuide/reference/subsystems/session-projection.md):
...
// (`/types`, zero imports), never the package root: the root's mnh-agent →
// mnh-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@aflydream/mnh-session-projection/types'

/**
 * The fifth framework hook seat (see the session-projection subsystem page,
 * AgentGuide/reference/subsystems/session-projection.md): key-addressed
