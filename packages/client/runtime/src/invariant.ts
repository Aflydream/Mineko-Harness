/**
 * Package-owned invariant companion for `@aflydream/mnh-client-runtime`.
 * @module @aflydream/mnh-client-runtime/invariant
 */
...
import type { SlotMap } from '@aflydream/mnh-client-ui-slots'
import type { InvariantInstaller } from '@aflydream/mnh-invariants'

const PACKAGE_NAME = '@aflydream/mnh-client-runtime'
