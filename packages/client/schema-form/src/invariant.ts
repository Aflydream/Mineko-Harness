/**
 * Package-owned invariant companion for `@aflydream/mnh-client-schema-form`.
 * @module @aflydream/mnh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-schema-form'
