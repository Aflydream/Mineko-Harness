...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  sectionIntro:
    ...
    + 'Duplicate an existing one and make it yours, or let the agent draft one for you in Plugin Builder.',
  builtIn: 'Built-in',
  ...
  create: 'Create',
  creating: 'Creating…',
  creatorDraft: 'Draft a custom preset with Plugin Builder',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  nav: 'Agent 预设',
  sectionIntro: '预设即一个会话的 Agent 所运行的插件组装 —— 它的工具、提示词与能力。复制一份既有预设改成自己的，或用「插件制作模式」让 Agent 帮你创建。',
  builtIn: '内置',
  setDefault: '设为默认',
  view: '查看',
