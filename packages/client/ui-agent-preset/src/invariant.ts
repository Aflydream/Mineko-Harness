/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-agent-preset`.
 * @module @aflydream/mnh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-agent-preset'
