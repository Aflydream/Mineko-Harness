/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-attachment`.
 * @module @aflydream/mnh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-attachment'
