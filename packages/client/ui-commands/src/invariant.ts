/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-commands`.
 * @module @aflydream/mnh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-commands'
