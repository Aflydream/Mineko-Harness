...
import type { CommandResult } from '@aflydream/mnh-commands/types'
import { createScope, scopeOf } from '@aflydream/mnh-client-runtime/client'
import type { SessionId } from '@aflydream/mnh-client-runtime/client'
import type { ClientSessionContext, ConsumeTokenRequest, InputTriggerPick, InputTriggerSource } from '@aflydream/mnh-client-ui-input-trigger/client'
