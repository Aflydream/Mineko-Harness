...
import { JsonBlock, MessageText, StateDot } from '@aflydream/mnh-client-ui-primitives'
import type { ChatNodeViewProps, ChatViewSlotProps } from '../contract/slots.ts'
import { ImageGallery, type ImageLoader } from '@aflydream/mnh-client-ui-attachment'
...
function TurnErrorItem({ node, t }: {
  ...
  const contextOverflow = node.code === 'CONTEXT_WINDOW_EXCEEDED'
  return (
    <div className={css.turnErrorRow} role="status">
      ...
      <div className={css.turnErrorCopy}>
        ...
        <span className={css.turnErrorMessage}>
          {contextOverflow ? t('message.contextOverflow') : node.message}
        </span>
        {contextOverflow && (
          <>
            <span className={css.turnErrorMessage}>{t('message.contextOverflow.hint')}</span>
            <span className={css.contextProviderMessage}>{node.message}</span>
          </>
        )}
      </div>
