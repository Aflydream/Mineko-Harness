...
export const zh = {
  ...
  'settings.contextProtection.title': '防截断模式',
  'settings.contextProtection.description': '检测到上下文超限或历史截断时保留原始记录，切换模型或渠道后再继续',
  'settings.contextProtection.enabled': '已开启',
  'settings.contextProtection.disabled': '已关闭',
  ...
  'hero.headline': 'Make Everything Happen',
  ...
  'message.contextOverflow': '当前模型或渠道的上下文窗口不足',
  'message.contextOverflow.hint': '历史记录未被改写。请切换模型或渠道后发送“继续”',
...
export const en = {
  ...
  'settings.contextProtection.title': 'Context protection',
  'settings.contextProtection.description': 'Keep the original history when context overflow or truncation is reported; switch model or provider before continuing',
  'settings.contextProtection.enabled': 'On',
  'settings.contextProtection.disabled': 'Off',
  ...
  'message.contextOverflow': 'The selected model or provider has insufficient context capacity',
  'message.contextOverflow.hint': 'Your history was not rewritten. Switch model or provider, then send “continue”.',
