// Hero chrome for the blank-draft phase of ConversationRoot: text identity,
// headline, glow backdrop, and workspace row. Pure presentation — the
...
import { workspaceTitleOf } from '@aflydream/mnh-client-runtime/client'
 ...
 * @param props.buttonRef - DOM button ref.
...
export function WorkspaceChip({ buttonRef, label, menuOpen = false, onClick, t }: {
  ...
  return (
    <LiquidGlassButton
      ...
      trailing={<IconChevronDownOutline14 className={css.chevron} size={12} />}
    >
...
/**
 * Render the hero chrome (identity text and headline).
