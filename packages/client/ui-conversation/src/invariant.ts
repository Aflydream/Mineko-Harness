/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-conversation`.
 * @module @aflydream/mnh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-conversation'
