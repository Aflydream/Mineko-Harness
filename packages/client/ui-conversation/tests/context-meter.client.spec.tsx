...
import { en as commonEn, zh as commonZh } from '@aflydream/mnh-client-locale/src/locales/index.ts'
...
describe('ContextMeter', () => {
  ...
  it('closes on outside pointerdown and Escape — but not inside clicks', () => {
    ...
    fireEvent.animationEnd(again)
    expect(view.container.querySelector('[role="dialog"]')).toBeNull()
    // Escape.
    openPanel()
    const closing = view.container.querySelector('[role="dialog"]')!
