...
import {
  CONVERSATION_SETTINGS_NAMESPACE, DEFAULT_BUSY_ENTER_BEHAVIOR, DEFAULT_PRESERVE_CONTEXT, apply,
} from '@aflydream/mnh-client-ui-conversation'
...
describe('ui-conversation host', () => {
  it('registers, validates, and disposes the durable busy-Enter preference', async () => {
    ...
    expect(ctx.settings.get(ns)).toEqual({
      ...
      preserveContext: DEFAULT_PRESERVE_CONTEXT,
    })
