...
import type { ClientContext, ConversationSnapshot, SessionId } from '@aflydream/mnh-client-runtime/client'
...
describe('image draft rail', () => {
  ...
  it('opens the original image on a single click and closes it with Escape', () => {
    ...
    fireEvent.animationEnd(dialog.querySelector('img')!)
...
describe('command launcher chrome and control seats', () => {
  ...
  it('requires explicit risk acknowledgement before submitting Full access', async () => {
    ...
    const dialog = view.getByRole('dialog', { name: '确认启用 Full access？' })
