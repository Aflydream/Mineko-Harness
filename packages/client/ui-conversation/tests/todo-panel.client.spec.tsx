...
import type { TodoItem } from '@aflydream/mnh-client-runtime/client'
...
describe('TodoDock', () => {
  it('reads the host-computed todos projection and follows pushed updates', () => {
    ...
    const closingPanel = screen.getByTestId('todo-panel')
    expect(closingPanel.className).toMatch(/closing/)
