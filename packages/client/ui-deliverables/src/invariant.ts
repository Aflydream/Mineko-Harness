/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-deliverables`.
 * @module @aflydream/mnh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-deliverables'
