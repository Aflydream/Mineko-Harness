...
import type { ChatFileMentions, TurnTailOwnerProps } from '@aflydream/mnh-client-ui-conversation/client'
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@aflydream/mnh-client-ui-deliverables'])
