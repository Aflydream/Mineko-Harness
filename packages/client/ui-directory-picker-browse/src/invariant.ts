/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-directory-picker-browse`.
 * @module @aflydream/mnh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-directory-picker-browse'
