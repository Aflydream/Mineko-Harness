/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-directory-picker-native`.
 * @module @aflydream/mnh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-directory-picker-native'
