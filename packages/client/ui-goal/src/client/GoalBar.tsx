...
import type { GoalSnapshot } from '@aflydream/mnh-goal/client'
import {
...
export type GoalDockProps = import('@aflydream/mnh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
