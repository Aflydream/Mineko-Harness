/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-goal`.
 * @module @aflydream/mnh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-goal'
