...
import { SlotRegistry, type SessionId } from '@aflydream/mnh-client-runtime/client'
import { ConversationEventRegistry } from '@aflydream/mnh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@aflydream/mnh-goal/client'
