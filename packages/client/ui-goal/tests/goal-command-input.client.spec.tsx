...
import { ConversationNodeAssembler } from '@aflydream/mnh-client-runtime/client'
...
import type { SessionEvent } from '@aflydream/mnh-session/types'
import { commandDefinition } from '@aflydream/mnh-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@aflydream/mnh-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
