/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-input-trigger`.
 * @module @aflydream/mnh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-input-trigger'
