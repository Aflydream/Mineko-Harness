...
import { createScope, scopeOf, SlotRegistry } from '@aflydream/mnh-client-runtime/client'
import type { SessionId } from '@aflydream/mnh-client-runtime/client'
import { apply, inject, InputTriggerService } from '@aflydream/mnh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@aflydream/mnh-client-ui-input-trigger/client'
