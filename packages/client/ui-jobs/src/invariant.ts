/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-jobs`.
 * @module @aflydream/mnh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-jobs'
