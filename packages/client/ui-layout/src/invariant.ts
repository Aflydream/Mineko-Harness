/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-layout`.
 * @module @aflydream/mnh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-layout'
