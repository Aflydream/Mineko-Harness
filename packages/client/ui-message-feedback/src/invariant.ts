/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-message-feedback`.
 * @module @aflydream/mnh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-message-feedback'
