/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-model-selection`.
 * @module @aflydream/mnh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-model-selection'
