...
import type { ModelSelection } from '@aflydream/mnh-api-remotes/client'
...
describe('ModelSelect reasoning effort', () => {
  it('retains the menu through exit and cancels a stale exit when reopened', () => {
    render(<ModelSelect
      locked={false}
      available
  ...
  it('finishes the menu exit when the session loses model selection', () => {
    ...
    const view = render(<ModelSelect {...shared} available />)
    fireEvent.click(screen.getByRole('button', { name: /选择模型/ }))
    const menu = screen.getByRole('menu')

    view.rerender(<ModelSelect {...shared} available={false} />)
