/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-permission-presets`.
 * @module @aflydream/mnh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-permission-presets'
