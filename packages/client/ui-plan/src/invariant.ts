/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-plan`.
 * @module @aflydream/mnh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-plan'
 ...
 * audited by mnh-plan-mode, while the control is a slot effect whose
