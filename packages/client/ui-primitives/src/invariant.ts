/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-primitives`.
 * @module @aflydream/mnh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-primitives'
