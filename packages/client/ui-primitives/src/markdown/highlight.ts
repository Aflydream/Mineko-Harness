 ...
 *
 * The three common markdown-fence and `run_code` grammars (TypeScript, shell,
 * JSON) are bundled with the client and register when the singleton is first
 * used. The
...
/** The synchronous highlighter, created on the first recognized code block. */
