/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-settings-general`.
 * @module @aflydream/mnh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-settings-general'
