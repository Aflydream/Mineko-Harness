...
import type { IApiClient } from '@aflydream/mnh-api-remotes/client'
import { Button, IconPlusOutline16, Modal } from '@aflydream/mnh-client-ui-primitives'
import type { SnapshotSelectorHook } from '@aflydream/mnh-client-web-react'
...
function Loaded({ injected }: { injected: ModelsSectionInjected }): ReactNode {
  ...
  // One fact decides whether an unconfigured whole-section provider gets the
  // compact setup card while the user is already on the Models page.
