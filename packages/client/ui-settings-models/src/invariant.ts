/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-settings-models`.
 * @module @aflydream/mnh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-settings-models'
