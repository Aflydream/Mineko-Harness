/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-settings-plugins`.
 * @module @aflydream/mnh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-settings-plugins'
