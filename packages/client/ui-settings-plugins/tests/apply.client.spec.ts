...
import { TestRemote, usePinnedBrowserLanguages } from '@aflydream/mnh-client-test-runtime'
import { SettingsScopeBinder } from '@aflydream/mnh-client-ui-settings/client'
import { apply, inject } from '@aflydream/mnh-client-ui-settings-plugins/client'
import type {
  ConfigurablePluginsTabInjected, PluginsSettingsSectionInjected,
} from '@aflydream/mnh-client-ui-settings-plugins/client'
