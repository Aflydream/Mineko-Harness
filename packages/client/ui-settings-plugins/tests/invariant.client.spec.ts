...
import * as PluginConfigInvariant from '@aflydream/mnh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@aflydream/mnh-client-ui-settings-plugins')
