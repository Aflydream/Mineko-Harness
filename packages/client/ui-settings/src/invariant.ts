/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-settings`.
 * @module @aflydream/mnh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-settings'
