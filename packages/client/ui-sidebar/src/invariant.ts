/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-sidebar`.
 * @module @aflydream/mnh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-sidebar'
