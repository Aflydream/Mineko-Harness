 ...
 * determinism
 * lives host-side — the pre-step boundary (`mnh-tool-skill`) recognizes a
...
import type { ConnectionHandle, SessionId, SkillEntry } from '@aflydream/mnh-api-remotes/client'
import type { ClientContext, ISessions } from '@aflydream/mnh-client-runtime/client'
import type { InputTriggerServiceContract, InputTriggerSource } from '@aflydream/mnh-client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (mnh-tool-skill) recognizes the leading /name and
