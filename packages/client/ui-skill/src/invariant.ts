/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-skill`.
 * @module @aflydream/mnh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-skill'
