/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-slots`.
 * @module @aflydream/mnh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-slots'
