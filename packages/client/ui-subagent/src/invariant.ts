/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-subagent`.
 * @module @aflydream/mnh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-subagent'
