...
const INDIRECTION_PREFIX = '--mnh-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--mnh-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--mnh-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--mnh-scrollbar-width)`); a rename in scrollbar.css without
