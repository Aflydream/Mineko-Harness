...
各类卡片的上限与 fallback 规则仍由对应的 [terminal](../../../AgentGuide/conventions.md)、[diff](../../../AgentGuide/conventions.md)、[read](../../../AgentGuide/conventions.md)、[search](../../../AgentGuide/conventions.md) 和 [web](../../../AgentGuide/conventions.md) Agent Note 负责。
