...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@aflydream/mnh-client-ui-slots'
import type { ToolCallBlock } from '@aflydream/mnh-client-runtime/client'
