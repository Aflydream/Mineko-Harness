 ...
 *
 * The read card is result-side only ([read card note](../../../../../../AgentGuide/architecture.md)):
 ...
 * @module
 */
import type { ReadBlockLine, ReadBlockProps } from '@aflydream/mnh-client-ui-primitives'
