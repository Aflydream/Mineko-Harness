...
import type { TerminalBlockLabels, TerminalBlockProps } from '@aflydream/mnh-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in mnh-client-runtime), leaving a terminal
