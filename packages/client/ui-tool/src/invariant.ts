/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-tool`.
 * @module @aflydream/mnh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-tool'
