...
import type { SessionProviderComponent, TranslateNS } from '@aflydream/mnh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@aflydream/mnh-client-ui-conversation/src/client/contract/slots.ts'
