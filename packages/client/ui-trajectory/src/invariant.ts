/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-trajectory`.
 * @module @aflydream/mnh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-trajectory'
