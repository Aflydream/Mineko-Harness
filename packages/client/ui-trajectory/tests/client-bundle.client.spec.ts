 ...
 * not built (`pnpm --filter @aflydream/mnh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@aflydream/mnh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@aflydream/mnh-client-runtime/client', await import('@aflydream/mnh-client-runtime/client')],
      ['@aflydream/mnh-client-ui-primitives', await import('@aflydream/mnh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@aflydream/mnh-client-locale/client')
