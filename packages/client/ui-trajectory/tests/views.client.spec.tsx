...
import { bindSnapshotSelector } from '@aflydream/mnh-client-web-react'
import { resolveSlotLabel } from '@aflydream/mnh-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@aflydream/mnh-client-runtime/client'
import { SlotRegistry } from '@aflydream/mnh-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@aflydream/mnh-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@aflydream/mnh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@aflydream/mnh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@aflydream/mnh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@aflydream/mnh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@aflydream/mnh-client-locale/client'
import { stubSettingsScope } from '@aflydream/mnh-client-test-runtime'
import type { LocaleKeysOf } from '@aflydream/mnh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@aflydream/mnh-client-ui-trajectory/client'
import { apply as nodeApply } from '@aflydream/mnh-client-ui-trajectory'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('mnh.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`mnh.trajectory.duration.${SID}`)).toBeNull()
  })
