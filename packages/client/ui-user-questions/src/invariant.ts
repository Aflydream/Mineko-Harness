/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-user-questions`.
 * @module @aflydream/mnh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-user-questions'
