/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-workspace`.
 * @module @aflydream/mnh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-workspace'
