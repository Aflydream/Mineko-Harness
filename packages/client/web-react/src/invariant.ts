/**
 * Package-owned invariant companion for `@aflydream/mnh-client-web-react`.
 * @module @aflydream/mnh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-web-react'
