 ...
 * `window.__MNH_BOOT__` into the two-view BootManifest (wire boundary)
...
import * as ModulesClient from '@aflydream/mnh-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type MnhWindow,
} from '@aflydream/mnh-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@aflydream/mnh-client-modules'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    this.manifest = parseBootManifest((globalThis as MnhWindow).__MNH_BOOT__)
    ...
    ;(globalThis as MnhWindow).__MNH_MODULES__ = this.modules
