...
import * as UiSlots from '@aflydream/mnh-client-ui-slots'
import * as WebReact from '@aflydream/mnh-client-web-react'
import * as UiPrimitives from '@aflydream/mnh-client-ui-primitives'
import * as UiAttachment from '@aflydream/mnh-client-ui-attachment'
import * as SchemaForm from '@aflydream/mnh-client-schema-form'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@aflydream/mnh-client-ui-slots': UiSlots,
    '@aflydream/mnh-client-web-react': WebReact,
    '@aflydream/mnh-client-ui-primitives': UiPrimitives,
    '@aflydream/mnh-client-ui-attachment': UiAttachment,
    '@aflydream/mnh-client-schema-form': SchemaForm,
