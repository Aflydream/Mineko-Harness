/**
 * Package-owned invariant companion for `@aflydream/mnh-code-runtime-worker-thread`.
 * @module @aflydream/mnh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-code-runtime-worker-thread'
