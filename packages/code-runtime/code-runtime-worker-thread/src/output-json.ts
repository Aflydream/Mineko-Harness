/** JSON string-prefix accounting for the outer-output ledger. @module @aflydream/mnh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@aflydream/mnh-code-runtime'
