/**
 * Package-owned invariant companion for `@aflydream/mnh-command-compact`.
 * @module @aflydream/mnh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-command-compact'
