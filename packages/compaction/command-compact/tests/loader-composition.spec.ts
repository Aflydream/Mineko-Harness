...
import * as commandCompact from '@aflydream/mnh-command-compact'
...
describe('command-compact real Loader composition', () => {
  it('discovers and executes /compact through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'mnh-command-compact-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@aflydream/mnh-command-compact', commandCompact],
    ])
