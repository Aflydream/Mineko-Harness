/**
 * Package-owned invariant companion for `@aflydream/mnh-compaction-tool-result-pruner`.
 * @module @aflydream/mnh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-compaction-tool-result-pruner'
