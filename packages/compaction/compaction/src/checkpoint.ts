 ...
 *
 * The seam itself lives in `@aflydream/mnh-compaction`, which re-exports these
 ...
 * `mnh-commands/brand` shape.
 *
 * @module @aflydream/mnh-compaction/checkpoint
 */

import type { MessageSource } from '@aflydream/mnh-llm/message'
