/** Package-owned compaction log-stream invariants. @module @aflydream/mnh-compaction/invariant */

import type { Context } from '@deepseek-ai/cordis'
import { isReplacementSurfaceEvent } from '@aflydream/mnh-session'
...
const PACKAGE_NAME = '@aflydream/mnh-compaction'
