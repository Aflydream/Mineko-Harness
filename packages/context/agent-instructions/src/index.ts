 ...
 * mount it as a no-op.
 *
 * @module @aflydream/mnh-agent-instructions
 */
...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@aflydream/mnh-tools'
