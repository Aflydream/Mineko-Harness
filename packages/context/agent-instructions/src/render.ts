 ...
 *
 * @module @aflydream/mnh-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$MNH_HOME`.
 * Discovery (`$MNH_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.mnh/AGENTS.md' || displayPath === '$MNH_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
