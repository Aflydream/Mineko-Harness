/**
 * Package-owned invariant companion for `@aflydream/mnh-session-reference`.
 * @module @aflydream/mnh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-reference'
