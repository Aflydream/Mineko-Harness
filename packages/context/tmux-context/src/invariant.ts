/**
 * Package-owned invariant companion for `@aflydream/mnh-tmux-context`.
 * @module @aflydream/mnh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tmux-context'
