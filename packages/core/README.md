...
The subsystem reference — the package-by-package loop map, the `Agent` handle and its delivery/interception contracts — is [AgentGuide/reference/subsystems/core.md](../../AgentGuide/reference/subsystems/core.md); the default runnable composition is [`examples/agent-spine-demo`](../examples/agent-spine-demo/README.md).
