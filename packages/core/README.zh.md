...
子系统参考——逐包循环图、`Agent` 句柄及其投递／拦截约定——见 [AgentGuide/reference/subsystems/core.md](../../AgentGuide/reference/subsystems/core.md)；默认可运行组合是 [`examples/agent-spine-demo`](../examples/agent-spine-demo/README.md)。
