 ...
 * @module @aflydream/mnh-agent-loop/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@aflydream/mnh-llm'
import type { InvariantFailure, InvariantInstaller } from '@aflydream/mnh-invariants'
import { foldRequestHeader } from '@aflydream/mnh-session'

const PACKAGE_NAME = '@aflydream/mnh-agent-loop'
