 ...
 * ([`mnh-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @aflydream/mnh-agent-tool-presentation
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import type { ToolPresentationMode } from '@aflydream/mnh-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `mnh-agent-presets` reports as an unusable row, naming this id.
