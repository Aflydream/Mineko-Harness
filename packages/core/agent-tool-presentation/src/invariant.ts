/**
 * Package-owned invariant companion for `@aflydream/mnh-agent-tool-presentation`.
 * @module @aflydream/mnh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-agent-tool-presentation'
 ...
 * registry's to hold, and `mnh-tools` observes it there.
 */
