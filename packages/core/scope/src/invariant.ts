/** Package-owned scoped-dispatch invariants. @module @aflydream/mnh-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@aflydream/mnh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@aflydream/mnh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@aflydream/mnh-scope'
