 ...
 *
 * @module @aflydream/mnh-session
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@aflydream/mnh-llm'
import { scopeOf, scopeTarget } from '@aflydream/mnh-scope'
import type { Scoped } from '@aflydream/mnh-scope'
import type { Message } from '@aflydream/mnh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@aflydream/mnh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@aflydream/mnh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@aflydream/mnh-session#Session',
        wireTypeSymbol: '@aflydream/mnh-session/types#SessionId',
