 ...
 *
 * @module @aflydream/mnh-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@aflydream/mnh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@aflydream/mnh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@aflydream/mnh-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@aflydream/mnh-scope`): scoped listeners
  ...
  constructor(ctx: Context, config: Config) {
    ...
    if (config.includeHarnessIdentity ?? true) {
      this.section({
        ...
        order: -100,
        text: 'You are an AI agent powered by MiNeko Herness.',
      })
    }
    this.section({
