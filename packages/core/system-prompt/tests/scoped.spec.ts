...
import { createScope, scopeOf } from '@aflydream/mnh-scope'
import type { Scope, ScopeKey } from '@aflydream/mnh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@aflydream/mnh-system-prompt'
import type { Config, PromptAssembly } from '@aflydream/mnh-system-prompt'
