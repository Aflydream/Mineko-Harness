...
The subsystem reference — `CredentialRef`, per-operation resolution, UI-safe `CredentialInfo`, provider layers — is [AgentGuide/reference/subsystems/credentials.md](../../AgentGuide/reference/subsystems/credentials.md).
