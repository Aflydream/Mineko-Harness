...
子系统参考——`CredentialRef`、按操作解析、对 UI 安全的 `CredentialInfo`、提供方层——见 [AgentGuide/reference/subsystems/credentials.md](../../AgentGuide/reference/subsystems/credentials.md)。
