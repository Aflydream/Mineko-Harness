...
import type { EntryInfo, Sandbox } from '@aflydream/mnh-e2b'

const VERSION_METADATA_KEY = 'mnh-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.mnh-${randomUUID()}.tmp`)
