/**
 * Package-owned invariant companion for `@aflydream/mnh-subprocess-e2b`.
 * @module @aflydream/mnh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-subprocess-e2b'
