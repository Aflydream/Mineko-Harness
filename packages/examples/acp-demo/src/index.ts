 ...
 * ({@link @aflydream/mnh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @aflydream/mnh-acp} bridge. The app owns those plugins through one
 ...
 * AgentGuide/reference/postmortem/0001).
 * @module @aflydream/mnh-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@aflydream/mnh-acp'
...
} from '@aflydream/mnh-session-persistence-jsonl'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning mnh-system-prompt schema does the same), while
