/**
 * Package-owned invariant companion for `@aflydream/mnh-agent-spine-demo`.
 * @module @aflydream/mnh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-agent-spine-demo'
