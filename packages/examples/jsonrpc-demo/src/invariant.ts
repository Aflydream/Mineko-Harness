/**
 * Package-owned invariant companion for `@aflydream/mnh-sdk-jsonrpc-demo`.
 * @module @aflydream/mnh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-sdk-jsonrpc-demo'
