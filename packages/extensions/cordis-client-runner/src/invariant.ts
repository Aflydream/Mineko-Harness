/**
 * Package-owned invariant companion for `@aflydream/mnh-cordis-client-runner`.
 * @module @aflydream/mnh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-cordis-client-runner'
