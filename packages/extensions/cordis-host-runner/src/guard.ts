 ...
 * @module @aflydream/mnh-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@aflydream/mnh-scope'
import { assertSupportedJsonSchema, defineTool } from '@aflydream/mnh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@aflydream/mnh-cordis-client-runner`, whose CTX_VERBS names this one its
