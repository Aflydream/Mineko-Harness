/**
 * Package-owned invariant companion for `@aflydream/mnh-cordis-host-runner`.
 * @module @aflydream/mnh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-cordis-host-runner'
