 ...
 * @module @aflydream/mnh-tool-cordis
 */
...
} from '@aflydream/mnh-cordis-host-runner'
import type { DynamicCordisReference } from '@aflydream/mnh-cordis-host-runner'
import { createUserMessage } from '@aflydream/mnh-llm'
import type { JsonValue } from '@aflydream/mnh-session'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the MNH process restarted.',
