/**
 * Package-owned invariant companion for `@aflydream/mnh-client-ui-cordis`.
 * @module @aflydream/mnh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-ui-cordis'
