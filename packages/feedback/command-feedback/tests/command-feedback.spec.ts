...
import SessionStore, { foldSurface, Session, SessionId } from '@aflydream/mnh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@aflydream/mnh-session-telemetry'
...
vi.mock('@aflydream/mnh-anonymous-user-id', () => ({
...
describe('@aflydream/mnh-command-feedback registration', () => {
