 ...
 * streams large files, and rejects binary data; line windows belong to `mnh-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @aflydream/mnh-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@aflydream/mnh-fs'
