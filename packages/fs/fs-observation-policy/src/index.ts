 ...
 * @module @aflydream/mnh-fs-observation-policy
 */

import type { Context } from '@deepseek-ai/cordis'
import { FsError } from '@aflydream/mnh-fs'
import type { FsObservation, FsTarget, FsVersion, FsWriteIntent } from '@aflydream/mnh-fs'
...
class ObservedStateGate {
  ...
  private owner(actor: object | undefined): object | undefined {
    ...
    // See the analyzer-divergence consequence in AgentGuide/architecture.md.
