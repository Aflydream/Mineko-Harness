 ...
 *
 * @module @aflydream/mnh-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@aflydream/mnh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@aflydream/mnh-tools'
import type { RetainedItems } from '@aflydream/mnh-output-retention'
import type { SpillRef } from '@aflydream/mnh-spill'
