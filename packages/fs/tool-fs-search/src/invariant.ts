/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-fs-search`.
 * @module @aflydream/mnh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-fs-search'
