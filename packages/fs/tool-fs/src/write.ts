 ...
 * @module @aflydream/mnh-tool-fs/src/write
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@aflydream/mnh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@aflydream/mnh-tools'
import type { FsWriteOutcome } from '@aflydream/mnh-fs'
