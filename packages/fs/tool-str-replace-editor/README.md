...
The generated [`str_replace_editor` schema](../../../AgentGuide/reference/tool-catalog.md#aflydreammnh-tool-str-replace-editor), including the configured `description`. The plugin contributes no standalone system-prompt section.
