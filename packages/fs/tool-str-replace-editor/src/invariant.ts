/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-str-replace-editor`.
 * @module @aflydream/mnh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-str-replace-editor'
