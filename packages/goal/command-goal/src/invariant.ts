/**
 * Package-owned invariant companion for `@aflydream/mnh-command-goal`.
 * @module @aflydream/mnh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-command-goal'
