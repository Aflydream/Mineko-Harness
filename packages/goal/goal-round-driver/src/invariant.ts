/** Package-owned goal-round prompt invariants. @module @aflydream/mnh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@deepseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@aflydream/mnh-goal'
import type { InvariantFailure, InvariantInstaller } from '@aflydream/mnh-invariants'
import type { Session, SessionEvent } from '@aflydream/mnh-session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@aflydream/mnh-goal-round-driver'
