...
import GoalService, { GoalId } from '@aflydream/mnh-goal'
import type { GoalView } from '@aflydream/mnh-goal'
import { createUserMessage, LlmAdapter, LlmError  } from '@aflydream/mnh-llm'
