...
import * as GoalSessionInvariant from '@aflydream/mnh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@aflydream/mnh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@aflydream/mnh-invariants'
import SessionStore, { SessionId, type Session } from '@aflydream/mnh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@aflydream/mnh-goal-round-driver',
    }))
  })
