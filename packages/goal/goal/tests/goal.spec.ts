...
import { createUserMessage, HarnessError } from '@aflydream/mnh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@aflydream/mnh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@aflydream/mnh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@aflydream/mnh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@aflydream/mnh-session').SessionEvent[]): StubAgent {
