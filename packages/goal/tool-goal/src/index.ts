 ...
 * @module @aflydream/mnh-tool-goal
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { GoalId } from '@aflydream/mnh-goal'
import type { GoalRef, GoalView } from '@aflydream/mnh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@aflydream/mnh-llm'
import { defineTool } from '@aflydream/mnh-tools'
import type { GenericCallView } from '@aflydream/mnh-tools'
