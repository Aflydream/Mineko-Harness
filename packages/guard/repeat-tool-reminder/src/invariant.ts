/**
 * Package-owned invariant companion for `@aflydream/mnh-repeat-tool-reminder`.
 * @module @aflydream/mnh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-repeat-tool-reminder'
