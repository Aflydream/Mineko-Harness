/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-call-timeout-policy`.
 * @module @aflydream/mnh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-call-timeout-policy'
