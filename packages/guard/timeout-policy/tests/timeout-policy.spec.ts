/**
 * Unit + real-load-path coverage for @aflydream/mnh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@aflydream/mnh-llm'
import SystemPrompt from '@aflydream/mnh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@aflydream/mnh-tools'
import * as timeoutPolicy from '@aflydream/mnh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@aflydream/mnh-tool-call-timeout-policy'
...
describe('mnh-tool-call-timeout-policy real-load-path guard', () => {
