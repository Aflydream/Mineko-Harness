 ...
 * @module @aflydream/mnh-hook-protocol
 */
...
export { createStopContinuationGuard, DEFAULT_MAX_STOP_CONTINUATIONS, MAX_STOP_CONTINUATIONS } from './stop-guard.ts'
export type { StopContinuationGuard } from './stop-guard.ts'
