...
/** Per-agent continuation state used to bound blocking Stop-hook chains. */
 ...
 * @param maxContinuations - maximum extra steps allowed for one agent turn.
 * @returns a guard whose state is isolated by agent object and turn number.
 */
