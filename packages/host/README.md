...
The subsystem references: [web-server.md](../../AgentGuide/reference/subsystems/web-server.md) and [workspace.md](../../AgentGuide/reference/subsystems/workspace.md) (the picker seam).
