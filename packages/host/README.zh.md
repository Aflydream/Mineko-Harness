...
mnh Web GUI 的宿主侧：所有客户端形态共享的 API 网关，以及承载它的普通 HTTP 服务器。浏览器侧位于 [`client/`](../client/README.md)；组合应用是 [`apps/cli`](../../apps/cli/README.md)，它启动 [`mnh-base` 组合包](../bundle/base/cordis.patch.yml) 来提供 [`apps/web`](../../apps/web/)。这些全是**产品**包。
...
子系统参考：[web-server.md](../../AgentGuide/reference/subsystems/web-server.md) 与 [workspace.md](../../AgentGuide/reference/subsystems/workspace.md)（选择器 seam）。
