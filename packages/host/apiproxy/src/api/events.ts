...
import type { AskUserQuestionItem } from '@aflydream/mnh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@aflydream/mnh-user-approval/types'
import type { Message } from '@aflydream/mnh-llm/types'
import type { MessageId } from '@aflydream/mnh-llm/brand'
import type { CallId } from '@aflydream/mnh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@aflydream/mnh-session/types'
import type { ToolCallView, ToolResultView } from '@aflydream/mnh-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// mnh-tools remains its owner.
export type { ToolCallView, ToolResultView } from '@aflydream/mnh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@aflydream/mnh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
