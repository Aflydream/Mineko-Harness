...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@aflydream/mnh-attachment'
 ...
 * the mnh-tools vocabulary into this schema and drift with it.
 */
