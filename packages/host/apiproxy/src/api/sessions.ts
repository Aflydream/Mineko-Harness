...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@aflydream/mnh-attachment'
import type { ContentBlock } from '@aflydream/mnh-llm/types'
import type { SessionEvent, SessionId } from '@aflydream/mnh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via mnh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@aflydream/mnh-session-projection/types'
