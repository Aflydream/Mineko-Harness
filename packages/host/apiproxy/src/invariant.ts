/**
 * Package-owned invariant companion for `@aflydream/mnh-host-apiproxy`.
 * @module @aflydream/mnh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-host-apiproxy'
