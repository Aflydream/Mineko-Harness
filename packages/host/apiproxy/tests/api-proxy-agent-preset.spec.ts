...
import AgentRegistry, { type AgentFactory } from '@aflydream/mnh-agent'
...
import { GoalId } from '@aflydream/mnh-goal'
...
async function harness(
  ...
  const cwd = realpathSync(mkdtempSync(join(tmpdir(), 'mnh-apiproxy-preset-')))
