...
import type { ApprovalRequestId } from '@aflydream/mnh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@aflydream/mnh-host-apiproxy/api'
import type { RpcId } from '@aflydream/mnh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@aflydream/mnh-host-apiproxy/api/rpc'
