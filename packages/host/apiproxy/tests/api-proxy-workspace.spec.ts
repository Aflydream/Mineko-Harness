...
import type { Agent, AgentFactory } from '@aflydream/mnh-agent'
...
import type { DirectoryPickerCapability } from '@aflydream/mnh-host-directory-picker'
import WorkspaceRegistry from '@aflydream/mnh-workspace'
import type { HostFrame, WorkspaceId } from '@aflydream/mnh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@aflydream/mnh-host-apiproxy/api/rpc'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'mnh-apiproxy-workspace-'))),
