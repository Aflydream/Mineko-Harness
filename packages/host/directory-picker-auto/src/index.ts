 ...
 * @module @aflydream/mnh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@aflydream/mnh-host-directory-picker-native',
  browse: '@aflydream/mnh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@aflydream/mnh-client-ui-directory-picker-native',
  browse: '@aflydream/mnh-client-ui-directory-picker-browse',
}
