/** Package-owned invariant companion for the directory-picker seam. @module @aflydream/mnh-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@aflydream/mnh-invariants'

const PACKAGE_NAME = '@aflydream/mnh-host-directory-picker'
