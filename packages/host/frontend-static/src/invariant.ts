/**
 * Package-owned invariant companion for `@aflydream/mnh-host-frontend-static`.
 * @module @aflydream/mnh-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@aflydream/mnh-invariants'

const PACKAGE_NAME = '@aflydream/mnh-host-frontend-static'
