/**
 * Package-owned invariant companion for `@aflydream/mnh-anonymous-user-id`.
 * @module @aflydream/mnh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-anonymous-user-id'
