/**
 * mnh-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@aflydream/mnh-brand`; this module
 ...
 * loading the host plugin's Context merges — the `mnh-llm/brand` shape.
 *
 * @module @aflydream/mnh-commands/brand
 */
