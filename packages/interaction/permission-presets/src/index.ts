 ...
 *
 * @module mnh-permission-presets
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { z as zod } from 'zod'
import type { Session, SessionEvent } from '@aflydream/mnh-session'
import type { SandboxMode } from '@aflydream/mnh-sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@aflydream/mnh-sandbox-policy'
...
import type {} from '@aflydream/mnh-shell'
import type { ApprovalPolicy } from '@aflydream/mnh-user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@aflydream/mnh-user-approval'
