...
The model sees the generated [`ask_user_question` schema](../../../AgentGuide/reference/tool-catalog.md#aflydreammnh-tool-ask-user), including question ids, prompts, headings, options, and multi-select flags.
