/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-ask-user`.
 * @module @aflydream/mnh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-ask-user'
