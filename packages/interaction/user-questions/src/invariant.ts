/**
 * Package-owned invariant companion for `@aflydream/mnh-user-questions`.
 * @module @aflydream/mnh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-user-questions'
