/**
 * Package-owned invariant companion for `@aflydream/mnh-jobs-local`.
 * @module @aflydream/mnh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-jobs-local'
...
/**
 * No runtime invariant: `@aflydream/mnh-jobs/invariant` owns per-snapshot identity, status,
