 ...
 * @module @aflydream/mnh-tool-jobs
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { boundContextSummary, createUserMessage, type ContentBlock } from '@aflydream/mnh-llm'
import { TextRetainer } from '@aflydream/mnh-output-retention'
import { defineTool } from '@aflydream/mnh-tools'
import type { GenericCallView, ToolDefinition, ToolExecution } from '@aflydream/mnh-tools'
