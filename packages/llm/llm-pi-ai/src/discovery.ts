 ...
 *
 * @module mnh-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@aflydream/mnh-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@aflydream/mnh-llm'
import { attributionHeaders } from '@aflydream/mnh-llm'
 ...
 * on the length the server claims — the same two-stage shape `mnh-web-fetch`
