/** Package-owned durable retry-event invariants. @module @aflydream/mnh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@aflydream/mnh-session'
import type { LlmFailure } from '@aflydream/mnh-llm'
...
const PACKAGE_NAME = '@aflydream/mnh-llm-retry'
