/**
 * mnh-llm's owned branded ids: tool-call correlation and provider request
 * diagnostics.
 *
 * The `Branded<B>` primitive itself lives in `@aflydream/mnh-brand` (a
 * zero-dependency type-only package) so every owner of a cross-boundary id can
 * brand it without depending on mnh-llm; see that package's README for the
 * nominal-typing policy.
 *
 * @module @aflydream/mnh-llm/brand
 */
