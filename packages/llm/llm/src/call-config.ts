 ...
 * @module mnh-llm/call-config
 */

import type { GenerateOptions } from './types.ts'
import type { ReasoningEffortId } from './brand.ts'

/** Process-local identities of request objects assembled by mnh-agent-loop. */
...
/**
 * Mark one exact request object as assembled by mnh-agent-loop.
...
/**
 * Test whether the exact request object was assembled by mnh-agent-loop.
