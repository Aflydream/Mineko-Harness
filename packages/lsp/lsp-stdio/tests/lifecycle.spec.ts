...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@aflydream/mnh-lsp'
...
import type { LspLocalServerConfig } from '@aflydream/mnh-lsp-stdio'
