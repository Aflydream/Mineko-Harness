 ...
 * `ctx.lsp` → `mnh-lsp-stdio` stack over the base protocol, exercising all four operations. No API
...
import Lsp, { type LspQueryRequest, type LspQueryResult } from '@aflydream/mnh-lsp'
import * as LspLocal from '@aflydream/mnh-lsp-stdio'
