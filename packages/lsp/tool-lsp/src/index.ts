 ...
 * `mnh-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @aflydream/mnh-tool-lsp
 */
...
import { LspError } from '@aflydream/mnh-lsp'
import type {} from '@aflydream/mnh-lsp'
