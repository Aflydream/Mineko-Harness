/**
 * Real-load-path guard for @aflydream/mnh-mcp-client. `mcp-client` is a
...
import * as mcpClient from '@aflydream/mnh-mcp-client'

describe('mnh-mcp-client real-load-path guard', () => {
