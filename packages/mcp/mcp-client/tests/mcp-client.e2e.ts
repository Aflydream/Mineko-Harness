/**
 * End-to-end tests for mnh-mcp-client. Exercises the REAL MCP protocol against:
...
import { apply } from '@aflydream/mnh-mcp-client/src/index.ts'
import { publicToolName } from '@aflydream/mnh-mcp-client/src/tools.ts'
