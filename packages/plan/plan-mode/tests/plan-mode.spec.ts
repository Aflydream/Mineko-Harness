...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@aflydream/mnh-tools'
import { Session, SessionId, type UserMessage } from '@aflydream/mnh-session'
import AgentRegistry, { agentEvents, type Agent } from '@aflydream/mnh-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@aflydream/mnh-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `mnh-plan-mode` beside real `SystemPrompt` and
