 ...
 * @module @aflydream/mnh-agent-presets/discovery
 */
...
import { expandHomePath } from '@aflydream/mnh-home-paths'
 ...
 *
 * This package owns the writable root the way `mnh-skill-filesystem` owns
 * `<mnhHome>/skills`. An app must assemble the SHIPPED root, whose path only
