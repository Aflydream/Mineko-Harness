/**
 * Package-owned invariant companion for `@aflydream/mnh-agent-presets`.
 * @module @aflydream/mnh-agent-presets/invariant
 */
...
// joins, and the `agent` field `mnh-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@aflydream/mnh-agent-presets'

const PACKAGE_NAME = '@aflydream/mnh-agent-presets'
