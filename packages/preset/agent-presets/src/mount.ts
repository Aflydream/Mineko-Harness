 ...
 * @module @aflydream/mnh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@aflydream/mnh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@aflydream/mnh-*` row would fail to import. The
 ...
 * invariant companion's service listener, and `mnh-invariants` is a
