...
import AgentRegistry, { assembleContextFor } from '@aflydream/mnh-agent'
import AgentLoop from '@aflydream/mnh-agent-loop'
import InvariantRegistry from '@aflydream/mnh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@aflydream/mnh-agent-presets'
import * as AgentPresetsInvariant from '@aflydream/mnh-agent-presets/invariant'
