...
import { createScope, type ScopeKey } from '@aflydream/mnh-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@aflydream/mnh-persona'
import { PERSONA_SECTION } from '@aflydream/mnh-persona'
