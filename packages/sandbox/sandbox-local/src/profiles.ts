 ...
 *
 * @module @aflydream/mnh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@aflydream/mnh-node-addon-landlock-run'
 ...
 * (`@aflydream/mnh-fs-sandbox`) can never drift apart.
