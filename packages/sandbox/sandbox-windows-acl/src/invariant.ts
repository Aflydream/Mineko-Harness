/**
 * Package-owned invariant companion for `@aflydream/mnh-sandbox-windows-acl`.
 * @module @aflydream/mnh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-sandbox-windows-acl'
