...
Through [`mnh-bash-sandbox`](../../shell/bash-sandbox/README.md) and [`mnh-tool-bash`](../../shell/tool-bash/README.md), failure to enforce a requested mode produces code `SANDBOX_UNAVAILABLE` and the exact error below. An execution-time runner failure adds ` Runner failure: <detail>`.
