/**
 * High-level run API over {@link HarnessClient}: `MiNekoHerness` owns one
 ...
 * Mirrors the Python SDK's `MiNekoHerness`/`Session` pair.
 *
...
import type { ContentBlock, MiNekoHernessOptions, HarnessClientOptions, HarnessNotification, RunResult } from './types.ts'

/**
 * Reusable SDK for running MiNeko Herness agent turns in a runtime
 ...
 * child is reaped.
 */
export class MiNekoHerness implements AsyncDisposable {
  ...
  constructor(options: MiNekoHernessOptions) {
...
export class HarnessSession {
   ...
   */
  constructor(readonly harness: MiNekoHerness, readonly id: string) {}
