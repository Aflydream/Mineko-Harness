/**
 * High-level run API over {@link HarnessClient}: `MiNekoHarness` owns one
 ...
 * Mirrors the Python SDK's `MiNekoHarness`/`Session` pair.
 *
 * @module @aflydream/mnh-sdk-client/api
 */
...
import type { ContentBlock, MiNekoHarnessOptions, HarnessClientOptions, HarnessNotification, RunResult } from './types.ts'

/**
 * Reusable SDK for running MiNeko Harness agent turns in a runtime
 ...
 * child is reaped.
 */
export class MiNekoHarness implements AsyncDisposable {
  ...
  constructor(options: MiNekoHarnessOptions) {
...
export class HarnessSession {
   ...
   */
  constructor(readonly harness: MiNekoHarness, readonly id: string) {}
