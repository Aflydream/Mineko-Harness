/**
 * Package-owned invariant companion for `@aflydream/mnh-sdk-protocol`.
 * @module @aflydream/mnh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-sdk-protocol'
