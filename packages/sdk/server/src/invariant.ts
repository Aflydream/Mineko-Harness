/**
 * Package-owned invariant companion for `@aflydream/mnh-sdk-jsonrpc-server`.
 * @module @aflydream/mnh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-sdk-jsonrpc-server'
