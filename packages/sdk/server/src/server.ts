 ...
 *
 * @module @aflydream/mnh-sdk-jsonrpc-server/server
 */

import type { Context } from '@deepseek-ai/cordis'
import { resolve } from 'node:path'
import type { Agent, AgentHandle } from '@aflydream/mnh-agent'
import { createUserMessage } from '@aflydream/mnh-llm'
import { carrierKeyOf, type Scoped } from '@aflydream/mnh-scope'
import { SessionId } from '@aflydream/mnh-session'
import type SubagentRuntime from '@aflydream/mnh-subagent'
import type { SubagentRunEndInfo } from '@aflydream/mnh-subagent'
