...
The subsystem reference — logical records, bounded reads, traces, filters, result pages — is [AgentGuide/reference/subsystems/session-query.md](../../AgentGuide/reference/subsystems/session-query.md).
