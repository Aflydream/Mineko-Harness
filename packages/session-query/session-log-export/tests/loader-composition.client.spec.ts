...
import * as SessionLogDownload from '@aflydream/mnh-session-log-export'
...
describe('session-log-download real Loader composition', () => {
  it('discovers and executes /export through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'mnh-session-export-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@aflydream/mnh-session-log-export', SessionLogDownload],
    ])
