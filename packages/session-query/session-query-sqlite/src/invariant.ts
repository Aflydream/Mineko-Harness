/**
 * Package-owned invariant companion for `@aflydream/mnh-session-query-sqlite`.
 * @module @aflydream/mnh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-query-sqlite'
