import { createAssistantMessage, createUserMessage } from '@aflydream/mnh-llm'
...
import type { SessionEvent, SessionHeader, SessionId as SessionIdType } from '@aflydream/mnh-session'
import SessionPersistence, { SessionPersistenceRevision } from '@aflydream/mnh-session-persistence'
import type { SessionPersistenceSnapshot } from '@aflydream/mnh-session-persistence'
import SqliteSessionPersistence from '@aflydream/mnh-session-persistence-sqlite'
import SqliteSessionQueryEngine, {
  SESSION_QUERY_SQLITE_SCHEMA_VERSION,
} from '@aflydream/mnh-session-query-sqlite'
import {
...
} from '@aflydream/mnh-session-query'
...
async function temporaryPath(name = 'search.db'): Promise<string> {
  const directory = await mkdtemp(join(tmpdir(), 'mnh-session-search-'))
