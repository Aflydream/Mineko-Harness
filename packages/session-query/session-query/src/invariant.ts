/**
 * Package-owned invariant companion for `@aflydream/mnh-session-query`.
 * @module @aflydream/mnh-session-query/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-query'
