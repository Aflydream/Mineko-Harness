/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-session-query`.
 * @module @aflydream/mnh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-session-query'
