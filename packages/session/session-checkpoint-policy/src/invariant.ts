/**
 * Package-owned invariant companion for `@aflydream/mnh-session-checkpoint-policy`.
 * @module @aflydream/mnh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-checkpoint-policy'
