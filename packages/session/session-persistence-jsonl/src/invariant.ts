/**
 * Package-owned invariant companion for `@aflydream/mnh-session-persistence-jsonl`.
 * @module @aflydream/mnh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-persistence-jsonl'
