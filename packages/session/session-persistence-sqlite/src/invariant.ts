/**
 * Package-owned invariant companion for `@aflydream/mnh-session-persistence-sqlite`.
 * @module @aflydream/mnh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-persistence-sqlite'
