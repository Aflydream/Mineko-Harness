/**
 * Package-owned invariant companion for `@aflydream/mnh-session-persistence`.
 * @module @aflydream/mnh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-persistence'
