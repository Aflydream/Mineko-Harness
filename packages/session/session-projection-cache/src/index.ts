 ...
 * @module @aflydream/mnh-session-projection-cache
 */
...
import type { ProjectionCheckpoint, ProjectionSnapshot } from '@aflydream/mnh-session-projection'
import type { KvTable } from '@aflydream/mnh-storage-domain'
