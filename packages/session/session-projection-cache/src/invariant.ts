/**
 * Package-owned invariant companion for `@aflydream/mnh-session-projection-cache`.
 * @module @aflydream/mnh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-projection-cache'
