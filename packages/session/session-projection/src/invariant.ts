/**
 * Package-owned invariant companion for `@aflydream/mnh-session-projection`.
 * @module @aflydream/mnh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-projection'
