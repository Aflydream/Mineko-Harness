/**
 * Package-owned invariant companion for `@aflydream/mnh-session-stats`.
 * @module @aflydream/mnh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-stats'
 ...
 * ids) are owned and runtime-checked by mnh-agent-loop and the session
 * surface, not here.
 */
