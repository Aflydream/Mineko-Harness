 ...
 * (`deriveStats` in mnh-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @aflydream/mnh-session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@aflydream/mnh-llm/message'
