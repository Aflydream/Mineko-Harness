/**
 * OpenTelemetry Service Provider for the MiNeko Harness telemetry capability.
 *
 ...
 *
 * @module @aflydream/mnh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@aflydream/mnh-command-feedback'
import {
...
} from '@aflydream/mnh-session-telemetry'
import { APP_IDENTITY } from '@aflydream/mnh-llm'
...
// version (same pattern as mnh-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@aflydream/mnh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@aflydream/mnh-session-telemetry-otel/ops', version)
