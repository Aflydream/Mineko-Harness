/**
 * Package-owned invariant companion for `@aflydream/mnh-session-telemetry-otel`.
 * @module @aflydream/mnh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-telemetry-otel'
