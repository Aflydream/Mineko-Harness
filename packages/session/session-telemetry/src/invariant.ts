/**
 * Package-owned invariant companion for `@aflydream/mnh-session-telemetry`.
 * @module @aflydream/mnh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-telemetry'
