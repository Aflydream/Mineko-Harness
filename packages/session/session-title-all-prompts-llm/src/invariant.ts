/**
 * Package-owned invariant companion for `@aflydream/mnh-session-title-all-prompts-llm`.
 * @module @aflydream/mnh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-title-all-prompts-llm'
