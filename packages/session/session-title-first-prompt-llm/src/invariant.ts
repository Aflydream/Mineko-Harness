/**
 * Package-owned invariant companion for `@aflydream/mnh-session-title-first-prompt-llm`.
 * @module @aflydream/mnh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-title-first-prompt-llm'
