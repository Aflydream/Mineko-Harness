 ...
 * @module @aflydream/mnh-session-title-llm
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@aflydream/mnh-llm'
import type { FinishReason, GenerateOptions, Message } from '@aflydream/mnh-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@aflydream/mnh-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@aflydream/mnh-session-title'
import type {
...
export async function generateSessionTitleWithLlm(
  ...
  const messages: Message[] = [createUserMessage({
    ...
    source: { kind: 'plugin', plugin: 'mnh-session-title-llm' },
  })]
