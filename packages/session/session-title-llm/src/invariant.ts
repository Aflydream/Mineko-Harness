/**
 * Package-owned invariant companion for `@aflydream/mnh-session-title-llm`.
 * @module @aflydream/mnh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-title-llm'
