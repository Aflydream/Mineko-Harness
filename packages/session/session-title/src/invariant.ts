/**
 * Package-owned invariant companion for `@aflydream/mnh-session-title`.
 * @module @aflydream/mnh-session-title/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-session-title'
