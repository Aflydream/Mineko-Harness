...
The subsystem reference — namespaces, owner scopes, resolution order, hot commits — is [AgentGuide/reference/subsystems/settings.md](../../AgentGuide/reference/subsystems/settings.md).
