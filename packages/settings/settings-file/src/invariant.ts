/**
 * Package-owned invariant companion for `@aflydream/mnh-settings-file`.
 * @module @aflydream/mnh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@aflydream/mnh-settings`.
 */
