...
| [`shell-env/`](shell-env/README.md) | Provides the managed `MNH_*` environment shared by shell tools. | `ctx.shellEnv` |
...
The subsystem reference — request/spec vocabulary, results, background processes, the service, and events — is [AgentGuide/reference/subsystems/shell.md](../../AgentGuide/reference/subsystems/shell.md).
