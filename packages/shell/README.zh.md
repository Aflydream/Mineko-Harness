...
| [`shell-env/`](shell-env/README.md) | 提供 shell 工具共享的托管 `MNH_*` 环境。 | `ctx.shellEnv` |
...
子系统参考——请求/spec 词汇、结果、后台进程、服务与事件——见 [AgentGuide/reference/subsystems/shell.md](../../AgentGuide/reference/subsystems/shell.md)。
