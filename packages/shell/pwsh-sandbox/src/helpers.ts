 ...
 * mirror of `@aflydream/mnh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @aflydream/mnh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@aflydream/mnh-shell'
import type { RunnerFailureRule } from '@aflydream/mnh-sandbox'
