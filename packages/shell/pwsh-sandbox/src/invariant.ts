/**
 * Package-owned invariant companion for `@aflydream/mnh-pwsh-sandbox`.
 * @module @aflydream/mnh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-pwsh-sandbox'
