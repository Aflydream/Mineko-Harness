/**
 * Shared rendering helpers for the shell tools (`mnh-tool-bash`,
 * `mnh-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @aflydream/mnh-shell/render
 */
