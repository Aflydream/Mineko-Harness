...
The generated [`bash` schema](../../../AgentGuide/reference/tool-catalog.md#aflydreammnh-tool-bash-persistent), including the configured `description`. The plugin contributes no standalone system-prompt section; the deployment owns persona and environment guidance.
