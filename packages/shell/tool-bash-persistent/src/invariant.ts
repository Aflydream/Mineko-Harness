/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-bash-persistent`.
 * @module @aflydream/mnh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-bash-persistent'
