 ...
 *
 * @module @aflydream/mnh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@aflydream/mnh-shell'
import type { SandboxMode } from '@aflydream/mnh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@aflydream/mnh-sandbox'
 ...
 * rendering story, owned by `@aflydream/mnh-shell` so `mnh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@aflydream/mnh-shell'
