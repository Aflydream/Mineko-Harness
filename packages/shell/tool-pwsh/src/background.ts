 ...
 * twin of `mnh-tool-bash`'s background adaptation.
 *
 * @module @aflydream/mnh-tool-pwsh/background
 */

import type { ShellProcess } from '@aflydream/mnh-shell'

/* jscpd:ignore-start -- deliberate twin of mnh-tool-bash/background.ts (Agent Note). */
