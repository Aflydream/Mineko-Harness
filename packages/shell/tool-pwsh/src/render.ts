 ...
 * `mnh-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @aflydream/mnh-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@aflydream/mnh-shell'
...
/* jscpd:ignore-start -- deliberate twin of mnh-tool-bash/render.ts (Agent Note). */
