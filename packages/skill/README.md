...
| [`skill-badge/`](skill-badge/README.md) | Contributes the optional bundled mnh badge skill | registers on `ctx.skills` |
...
The subsystem reference — discovery priority, catalog snapshots, the `skill` loader — is [AgentGuide/reference/subsystems/skills.md](../../AgentGuide/reference/subsystems/skills.md).
