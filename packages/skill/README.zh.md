...
| [`skill-badge/`](skill-badge/README.md) | 贡献可选的内置 mnh 徽章 skill | 注册到 `ctx.skills` |
...
子系统参考——发现优先级、目录快照、`skill` 加载器——见 [AgentGuide/reference/subsystems/skills.md](../../AgentGuide/reference/subsystems/skills.md)。
