/**
 * Bundled `mnh-badge` skill provider.
 *
 * @module @aflydream/mnh-skill-badge
 */
...
const PROVIDER_NAME = 'mnh-badge'
const SKILL_BODY_URL = new URL('../assets/mnh-badge.md', import.meta.url)
const RESOURCE_BASE = {
  kind: 'directory',
...
/** Register the bundled `mnh-badge` provider on `ctx.skills`. */
