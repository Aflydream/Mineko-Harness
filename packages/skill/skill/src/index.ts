 ...
 * Concrete
 * providers such as `@aflydream/mnh-skill-filesystem` decide where skills come
 ...
 *
 * @module @aflydream/mnh-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { assertNever } from '@aflydream/mnh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@aflydream/mnh-scope'
import type { ScopeKey, ScopeLayer } from '@aflydream/mnh-scope'
...
export type SkillSource = 'project-mnh' | 'project-agents' | 'runtime' | 'user-mnh' | 'user-agents' | 'custom' | 'bundled' | (string & {})
