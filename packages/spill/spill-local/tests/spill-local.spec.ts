...
import type { SaveTextSpill } from '@aflydream/mnh-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@aflydream/mnh-spill-local'

let root: string

beforeEach(() => {
  root = mkdtempSync(join(tmpdir(), 'mnh-spill-test-'))
})
afterEach(() => {
