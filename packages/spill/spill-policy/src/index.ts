 ...
 * `@aflydream/mnh-output-retention` (`TextRetainer`), storage is `ctx.spillStore`.
 ...
 *
 * @module @aflydream/mnh-spill-policy
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import type { ContentBlock } from '@aflydream/mnh-llm'
import { TextRetainer, describeOmitted } from '@aflydream/mnh-output-retention'
import type { Omitted } from '@aflydream/mnh-output-retention'
import type { SaveTextSpill, SpillRef } from '@aflydream/mnh-spill'
import type { SessionId } from '@aflydream/mnh-session'
import type { CallId } from '@aflydream/mnh-llm'
import type { PostToolDecision, ToolExecution } from '@aflydream/mnh-tools'
