/**
 * Package-owned invariant companion for `@aflydream/mnh-storage-domain`: every
 ...
 * @module @aflydream/mnh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-storage-domain'
