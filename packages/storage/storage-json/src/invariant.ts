/**
 * Package-owned invariant companion for `@aflydream/mnh-storage-json`.
 * @module @aflydream/mnh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-storage-json'
