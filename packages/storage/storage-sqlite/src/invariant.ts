/**
 * Package-owned invariant companion for `@aflydream/mnh-storage-sqlite`.
 * @module @aflydream/mnh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-storage-sqlite'
