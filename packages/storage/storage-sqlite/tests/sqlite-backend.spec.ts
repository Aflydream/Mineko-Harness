...
import Storage, { storageBackendServiceKey } from '@aflydream/mnh-storage'
import type { KvUnitDescriptor } from '@aflydream/mnh-storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'mnh-storage-sqlite-'))
  dirs.push(dir)
