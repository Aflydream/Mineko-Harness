...
| [`subagent-mnh-sdk/`](subagent-mnh-sdk/README.md) | 通过 TypeScript SDK 启动进程外 Harness 子 agent | 注册到 `ctx.subagents` |
...
参见有关[能力家族](../../AgentGuide/conventions.md)、[可继续执行的子级](../../AgentGuide/conventions.md)和[控制工具](../../AgentGuide/conventions.md)的决策。

子系统参考——启动请求、结果、实时运行、提供方约定、可续跑后台子 agent——见 [AgentGuide/reference/subsystems/subagent.md](../../AgentGuide/reference/subsystems/subagent.md)；设计依据见 [subagent 能力 seam](../../AgentGuide/conventions.md)、[可续跑后台 subagent](../../AgentGuide/conventions.md)与[合并 subagent 控制服务](../../AgentGuide/conventions.md) Agent Note。
