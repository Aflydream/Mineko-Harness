/**
 * Package-owned invariant companion for `@aflydream/mnh-subagent-codex`.
 * @module @aflydream/mnh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-subagent-codex'
