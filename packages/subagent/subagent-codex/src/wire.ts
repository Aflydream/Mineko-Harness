 ...
 *
 * @module @aflydream/mnh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@aflydream/mnh-llm'
import type { SubagentResult } from '@aflydream/mnh-subagent'
import { JsonRpcLineTransport } from '@aflydream/mnh-sdk-protocol'
