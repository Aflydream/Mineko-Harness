 ...
 * one result.
 *
 * @module @aflydream/mnh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@deepseek-ai/cordis'
import { foldConsumedWork } from '@aflydream/mnh-agent'
...
import { createUserMessage, type ContentBlock } from '@aflydream/mnh-llm'
import {
