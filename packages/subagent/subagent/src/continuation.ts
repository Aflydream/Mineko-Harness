...
import { boundContextSummary, createUserMessage, errorChain } from '@aflydream/mnh-llm'
import type { ContentBlock, MessageId, MessageSource } from '@aflydream/mnh-llm'
...
import type { ToolRestriction } from '@aflydream/mnh-tools'
...
export class SubagentContinuationManager {
  ...
  private requirePersistence(): SessionPersistence {
    ...
    if (persistence === undefined) {
      throw new SubagentError(
        'continuable subagents require session persistence (load a mnh-session-persistence backend)',
