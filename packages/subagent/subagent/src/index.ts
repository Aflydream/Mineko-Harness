 ...
 * (`@aflydream/mnh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@aflydream/mnh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@aflydream/mnh-tools'
import type { ContentBlock, MessageId } from '@aflydream/mnh-llm'
