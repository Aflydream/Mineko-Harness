...
import type { SessionProjectionRegistry } from '@aflydream/mnh-session-projection'
import type { SessionProjectionCache } from '@aflydream/mnh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @aflydream/mnh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @aflydream/mnh-session)',
