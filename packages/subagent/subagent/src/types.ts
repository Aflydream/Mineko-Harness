 ...
 *
 * @module @aflydream/mnh-subagent/types
 */

import type { Agent, AgentOptions } from '@aflydream/mnh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@aflydream/mnh-tools'
