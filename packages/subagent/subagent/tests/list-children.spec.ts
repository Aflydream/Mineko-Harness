...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@aflydream/mnh-session'
import type { SessionEvent, SessionHeader } from '@aflydream/mnh-session'
...
import type { ProjectionDefinition } from '@aflydream/mnh-session-projection'
import SessionProjectionCache from '@aflydream/mnh-session-projection-cache'
import Storage from '@aflydream/mnh-storage'
import { DomainFacility } from '@aflydream/mnh-storage-domain'
...
import * as SubagentFork from '@aflydream/mnh-subagent-fork-in-process'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'mnh-subagent-list-'))
  roots.push(root)
...
declare module '@aflydream/mnh-session-projection/types' {
