/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-subagent-control`.
 * @module @aflydream/mnh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-subagent-control'
