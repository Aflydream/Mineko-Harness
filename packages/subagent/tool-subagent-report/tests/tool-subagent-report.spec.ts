...
import { assembleContextFor } from '@aflydream/mnh-agent'
...
import type { GenerateOptions, StreamChunk } from '@aflydream/mnh-llm'
...
import * as control from '@aflydream/mnh-tool-subagent-control'
...
async function setup(options: { load?: boolean; config?: tool.Config } = {}) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'mnh-tool-subagent-report-'))
...
describe('mnh-tool-subagent-report', () => {
...
describe('mnh-tool-subagent-report result independence', () => {
