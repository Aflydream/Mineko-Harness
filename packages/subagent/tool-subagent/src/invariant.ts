/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-subagent`.
 * @module @aflydream/mnh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-subagent'
