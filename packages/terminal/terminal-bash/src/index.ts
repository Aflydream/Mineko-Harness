 ...
 * @module @aflydream/mnh-terminal-bash
 */

import { Context } from '@deepseek-ai/cordis'
import type { Agent } from '@aflydream/mnh-agent'
import type { Session, SessionEvent } from '@aflydream/mnh-session'
import { TerminalBackendCleanupError } from '@aflydream/mnh-terminal'
import type { TerminalBackend, TerminalBackendSpawnSpec } from '@aflydream/mnh-terminal'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@aflydream/mnh-subprocess'
import type { SandboxExecutionPolicy } from '@aflydream/mnh-sandbox'
import { effectiveSandboxMode } from '@aflydream/mnh-sandbox-policy'
...
function childEnvironment(spec: TerminalBackendSpawnSpec): Record<string, string> {
  ...
  return {
    ...
    MNH_SHELL: '1',
    MNH_SESSION_ID: spec.owner.id,
    MNH_PTY_SESSION_ID: spec.sessionId,
  }
}
