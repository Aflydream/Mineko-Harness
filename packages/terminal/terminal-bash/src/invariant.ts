/**
 * Package-owned invariant companion for `@aflydream/mnh-terminal-bash`.
 * @module @aflydream/mnh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-terminal-bash'
