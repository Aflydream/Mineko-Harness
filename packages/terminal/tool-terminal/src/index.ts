 ...
 * @module @aflydream/mnh-tool-terminal
 */
...
import { TerminalSessionId } from '@aflydream/mnh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@aflydream/mnh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @aflydream/mnh-jobs and @aflydream/mnh-tool-jobs')
