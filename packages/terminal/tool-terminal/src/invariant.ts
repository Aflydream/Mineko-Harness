/**
 * Package-owned invariant companion for `@aflydream/mnh-tool-terminal`.
 * @module @aflydream/mnh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-tool-terminal'
