/**
 * Package-owned invariant companion for `@aflydream/mnh-agent-loop-testkit`.
 * @module @aflydream/mnh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-agent-loop-testkit'
