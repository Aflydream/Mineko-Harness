/**
 * Package-owned invariant companion for `@aflydream/mnh-client-test-runtime`.
 * @module @aflydream/mnh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-client-test-runtime'
