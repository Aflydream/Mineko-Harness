/**
 * Package-owned invariant companion for `@aflydream/mnh-llm-mock-server`.
 * @module @aflydream/mnh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-llm-mock-server'
