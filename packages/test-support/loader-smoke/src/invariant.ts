/**
 * Package-owned invariant companion for `@aflydream/mnh-loader-smoke`.
 * @module @aflydream/mnh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-loader-smoke'
