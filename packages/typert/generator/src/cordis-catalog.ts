 ...
 * @module @aflydream/mnh-typert-generator
 */
...
function renderRuntimeApi(
  ...
  const lines: string[] = [
    ...
    ' * docs cannot diverge.',
    ' *',
    ' * @module @aflydream/mnh-tool-cordis/api-catalog',
    ' */',
    '',
    '/* jscpd:ignore-start */',
 ...
 * @param page - the owning `AgentGuide/reference/subsystems/` page basename, e.g. `core.md`.
