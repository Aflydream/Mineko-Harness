/**
 * Package-owned invariant companion for `@aflydream/mnh-typert-generator`.
 * @module @aflydream/mnh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-typert-generator'
