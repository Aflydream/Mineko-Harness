/**
 * Package-owned invariant companion for `@aflydream/mnh-typert-loader`.
 * @module @aflydream/mnh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-typert-loader'
