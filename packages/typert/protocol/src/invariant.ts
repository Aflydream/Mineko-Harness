/**
 * Package-owned invariant companion for `@aflydream/mnh-typert-protocol`.
 * @module @aflydream/mnh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-typert-protocol'
