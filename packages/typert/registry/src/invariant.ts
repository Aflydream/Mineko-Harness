/**
 * Package-owned invariant companion for `@aflydream/mnh-typert-registry`.
 * @module @aflydream/mnh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-typert-registry'
