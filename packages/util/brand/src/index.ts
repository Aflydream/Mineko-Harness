 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in mnh-llm (tool-call
 * correlation), the shared agent/session `SessionId` in mnh-session, and
 * `JobId` in mnh-jobs. Branding is for ids that cross package boundaries and
