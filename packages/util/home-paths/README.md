...
`mnhHomeDisplay()` names an active root symbolically for user-facing paths: `~/.mnh` for the default home, `$MNH_HOME` for any configured home. It never leaks an absolute machine path.
