/**
 * Package-owned invariant companion for `@aflydream/mnh-launch-environment`.
 * @module @aflydream/mnh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-launch-environment'
