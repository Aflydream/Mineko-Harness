/**
 * Package-owned invariant companion for `@aflydream/mnh-native-command`.
 * @module @aflydream/mnh-native-command/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-native-command'
