/**
 * Package-owned invariant companion for `@aflydream/mnh-output-retention`.
 * @module @aflydream/mnh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-output-retention'
