...
The [web capability decision](../../AgentGuide/architecture.md) records why search and fetch share one provider-selection service.

The subsystem reference — search/fetch requests and results, availability, `WebError` — is [AgentGuide/reference/subsystems/web.md](../../AgentGuide/reference/subsystems/web.md); rationale (including deferred SSRF protection) in the [web capability seam Agent Note](../../AgentGuide/architecture.md).
