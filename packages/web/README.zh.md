...
[web 能力决策](../../AgentGuide/architecture.md)记录了搜索和抓取共用一项提供方选择服务的原因。

子系统参考——搜索/抓取请求与结果、可用性、`WebError`——见 [AgentGuide/reference/subsystems/web.md](../../AgentGuide/reference/subsystems/web.md)；依据（含延后的 SSRF 防护）见 [web 能力 seam Agent Note](../../AgentGuide/architecture.md)。
