...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@aflydream/mnh-tools'
import type { WebFetchBody, WebFetchResult } from '@aflydream/mnh-web'
 ...
 * `@aflydream/mnh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@aflydream/mnh-tool-call-timeout-policy` to enforce.
