 ...
 * (`mnh-spill-local` backend + `mnh-spill-policy`), exercised through
...
import LocalSpillStore from '@aflydream/mnh-spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'mnh-spill-web-'))
