/**
 * `@aflydream/mnh-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @aflydream/mnh-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'mineko-harness/0.0.1 (+https://github.com/deepseek-ai)'
