 ...
 * `@aflydream/mnh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @aflydream/mnh-web-fetch-http/provider
 */

import { WebError } from '@aflydream/mnh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@aflydream/mnh-web'
