/**
 * Package-owned invariant companion for `@aflydream/mnh-web-search-deepseek`.
 * @module @aflydream/mnh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-web-search-deepseek'
