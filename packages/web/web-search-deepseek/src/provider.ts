 ...
 * @module @aflydream/mnh-web-search-deepseek/provider
 */

import { WebError } from '@aflydream/mnh-web'
import type {
  WebSearchProvider,
  WebSearchRequest,
  WebSearchResult,
  WebSearchSource,
} from '@aflydream/mnh-web'
import type { CredentialRef } from '@aflydream/mnh-credentials'
import type {} from '@aflydream/mnh-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@aflydream/mnh-llm-deepseek` uses, so this
...
const USER_AGENT = 'mineko-harness/0.0.1'
