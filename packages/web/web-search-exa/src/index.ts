/**
 * `@aflydream/mnh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@aflydream/mnh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@aflydream/mnh-web`.
 *
 * @module @aflydream/mnh-web-search-exa
 */

import type { Context } from '@deepseek-ai/cordis'
import { launchEnvironmentOf } from '@aflydream/mnh-launch-environment'
import z from '@deepseek-ai/schemastery'
import type {} from '@aflydream/mnh-web'
import {
  ExaSearchProvider,
