...
worker thread 将工作流执行与宿主事件循环隔离，但不构成安全边界。参见[动态工作流](../../AgentGuide/conventions.md)和 [Ralph 工具](../../AgentGuide/conventions.md)决策。

子系统参考——启动请求、`WorkflowMeta`、结果、实时运行、`workflow/*` 事件——见 [AgentGuide/reference/subsystems/workflow.md](../../AgentGuide/reference/subsystems/workflow.md)；决策见[动态工作流](../../AgentGuide/conventions.md)与 [Ralph 消费方](../../AgentGuide/conventions.md) Agent Note。
