 ...
 * (`@aflydream/mnh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @aflydream/mnh-tool-workflow
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool } from '@aflydream/mnh-tools'
import type { ToolCallView, ToolResultView } from '@aflydream/mnh-tools'
import type { ContentBlock } from '@aflydream/mnh-llm'
import type { JsonValue, Session, SessionEventMap } from '@aflydream/mnh-session'
import type {
