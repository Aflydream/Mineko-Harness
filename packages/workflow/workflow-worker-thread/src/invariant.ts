/**
 * Package-owned invariant companion for `@aflydream/mnh-workflow-worker-thread`.
 * @module @aflydream/mnh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@aflydream/mnh-workflow-worker-thread'
