...
子系统参考——实体、realpath 规范、注册/解析——见 [AgentGuide/reference/subsystems/workspace.md](../../AgentGuide/reference/subsystems/workspace.md)；存储设计见 [domain KV 存储 Agent Note](../../AgentGuide/architecture.md)。
