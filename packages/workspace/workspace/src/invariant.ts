/**
 * Package-owned invariant companion for `@aflydream/mnh-workspace`.
 * @module @aflydream/mnh-workspace/invariant
 */
...
import { WorkspaceId } from '@aflydream/mnh-workspace'

const PACKAGE_NAME = '@aflydream/mnh-workspace'
