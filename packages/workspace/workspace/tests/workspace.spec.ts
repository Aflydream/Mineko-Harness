...
import type { StorageBackend } from '@aflydream/mnh-storage'
import { DomainFacility } from '@aflydream/mnh-storage-domain'
import type { DomainChanged } from '@aflydream/mnh-storage-domain'
import SessionStore, { SessionId } from '@aflydream/mnh-session'
import type { SessionHeader } from '@aflydream/mnh-session'
...
async function makeDir(name: string): Promise<string> {
  base ??= await realpath(await mkdtemp(join(tmpdir(), 'mnh-workspace-')))
