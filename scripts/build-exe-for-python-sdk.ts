...
const DEPLOY_ROOT_PACKAGE = 'mnh-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@aflydream/mnh-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'mnh-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/mineko_harness_runtime/runtime'
...
class BuildCli {
  ...
  private static usage(): string {
    return [
      ...
      '',
      `Build route: ${PKG_SPEC} --sea; see AgentGuide/architecture.md.`,
