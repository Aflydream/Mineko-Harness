...
export const CORDIS_CORE_API_PAGES: CordisCoreApiPage[] = [
  {
    out: 'AgentGuide/reference/cordis-api/context.md',
    title: 'Context',
  ...
  {
    out: 'AgentGuide/reference/cordis-api/events.md',
    title: 'Events',
  ...
  {
    out: 'AgentGuide/reference/cordis-api/fiber.md',
    title: 'Fiber',
  ...
  {
    out: 'AgentGuide/reference/cordis-api/registry.md',
    title: 'Registry',
