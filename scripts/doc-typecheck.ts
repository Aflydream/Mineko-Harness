...
const markdownGlobs = ['README.md', 'AgentGuide/architecture.md', 'docs/**/*.md', 'packages/*/*.md', 'packages/*/*/*.md']
...
const useBuiltTypes = process.env.MNH_DOC_TYPECHECK_USE_BUILD_OUTPUT === '1'
