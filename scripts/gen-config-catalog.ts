/**
 * Generate `AgentGuide/reference/config-catalog.md` from package entry points, config types,
...
const OUT = 'AgentGuide/reference/config-catalog.md'
...
export interface CatalogEntry {
  /** npm package name, e.g. `@aflydream/mnh-agent-loop`. */
  pkg: string
...
export function render(entries: CatalogEntry[]): string {
  ...
  lines.push(
    ...
    '',
    'Abstract service classes — a deployment loads a concrete implementation package instead ([capability seams](../architecture.md)).',
    '',
