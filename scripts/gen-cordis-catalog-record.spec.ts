...
const PAGE = 'AgentGuide/reference/subsystems/fix.md'
const ZH = 'AgentGuide/reference/subsystems/fix.zh.md'
const META = 'AgentGuide/reference/subsystems/fix.i18n.yaml'
...
function setup(options: {
  ...
  roots.push(root)
  mkdirSync(join(root, 'AgentGuide/reference/subsystems'), { recursive: true })
