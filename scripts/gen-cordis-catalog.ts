 ...
 * maps to exactly one `AgentGuide/reference/subsystems/` page through the curated tables below;
 ...
 * `AgentGuide/reference/cordis-api/inherited.md`. `--check` verifies every generated artifact.
 *
...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@aflydream/mnh-typert-generator'
import type { CordisCatalogPolicy } from '@aflydream/mnh-typert-generator'
...
const SUBSYSTEMS_DIR = 'AgentGuide/reference/subsystems'
const OUT_INHERITED = 'AgentGuide/reference/cordis-api/inherited.md'
...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  desktopBridge: 'desktop-bridge.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  agent: 'not a service: the DX accessor field on Agent.ctx (root accessor defaulting to undefined) — AgentGuide/reference/subsystems/core.md owns the Agent handle',
  ...
  mnhHomePath: 'not a service: boot-provided root accessor function (typeof mnhHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  DesktopFetchRoute: 'desktop transport route is owned by packages/host/desktop-bridge/src/index.ts',
  DesktopPort: 'desktop transport port is owned by packages/host/desktop-bridge/src/index.ts',
 ...
 * @param pageRel - repo-relative English page path (`AgentGuide/reference/subsystems/x.md`).
