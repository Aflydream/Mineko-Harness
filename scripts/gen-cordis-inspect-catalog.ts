...
import type { CordisCatalogModel, ServiceMethodEntry } from '@aflydream/mnh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@aflydream/mnh-tool-cordis/api-catalog', '@aflydream/mnh-cordis-client-runner/client/api-catalog')
