/**
 * Generate `AgentGuide/reference/module-graph.md` from in-repo `peerDependencies`, the canonical
...
const OUT = 'AgentGuide/reference/module-graph.md'
...
/** Render the full AgentGuide/reference/module-graph.md content (pure, deterministic). */
