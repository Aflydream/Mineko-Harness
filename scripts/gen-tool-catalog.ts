/**
 * Generate `AgentGuide/reference/tool-catalog.md` from schemas collected by booting each tool
 ...
 * `AgentGuide/architecture.md`.
 */

import { globSync, readFileSync, writeFileSync } from 'node:fs'
import { basename, resolve } from 'node:path'
import { Context } from '@deepseek-ai/cordis'
import type { ToolSchema } from '@aflydream/mnh-llm'
import AgentRegistry from '@aflydream/mnh-agent'
import type { Agent } from '@aflydream/mnh-agent'
import { createScope } from '@aflydream/mnh-scope'
import SessionStore, { SessionId } from '@aflydream/mnh-session'
import SessionProjectionRegistry from '@aflydream/mnh-session-projection'
import SqliteSessionQueryEngine from '@aflydream/mnh-session-query-sqlite'
import GoalService from '@aflydream/mnh-goal'
import SystemPrompt from '@aflydream/mnh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@aflydream/mnh-tools'
import LocalBashExecutor from '@aflydream/mnh-bash-local'
import * as BashEnvPlugin from '@aflydream/mnh-shell-env'
import { PwshLocalExecutor } from '@aflydream/mnh-pwsh-local'
import LocalSubprocessRuntime from '@aflydream/mnh-subprocess-local'
import LocalFileSystem from '@aflydream/mnh-fs-local'
import { AttachmentStore } from '@aflydream/mnh-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@aflydream/mnh-attachment'
import UserQuestionService from '@aflydream/mnh-user-questions'
import PlanModeController from '@aflydream/mnh-plan-mode'
import WebRuntime from '@aflydream/mnh-web'
import * as WebSearchExa from '@aflydream/mnh-web-search-exa'
import * as WebFetchLocal from '@aflydream/mnh-web-fetch-http'
import SubagentRuntime from '@aflydream/mnh-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@aflydream/mnh-subagent'
import * as ToolSubagentControl from '@aflydream/mnh-tool-subagent-control'
import * as ToolSubagentListAgents from '@aflydream/mnh-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@aflydream/mnh-tool-subagent-report'
import SkillRegistry from '@aflydream/mnh-skill'
import * as SkillFileSystem from '@aflydream/mnh-skill-filesystem'
import LocalJobRegistry from '@aflydream/mnh-jobs-local'
import * as ToolAskUser from '@aflydream/mnh-tool-ask-user'
import * as ToolBash from '@aflydream/mnh-tool-bash'
import * as ToolPwsh from '@aflydream/mnh-tool-pwsh'
import * as ToolBashPersistent from '@aflydream/mnh-tool-bash-persistent'
import CordisHostRunner from '@aflydream/mnh-cordis-host-runner'
import * as ToolCordis from '@aflydream/mnh-tool-cordis'
import * as ToolFs from '@aflydream/mnh-tool-fs'
import * as ToolFsSearch from '@aflydream/mnh-tool-fs-search'
import * as ToolStrReplaceEditor from '@aflydream/mnh-tool-str-replace-editor'
import TerminalSessionService from '@aflydream/mnh-terminal'
import * as ToolPty from '@aflydream/mnh-tool-terminal'
import * as ToolGoal from '@aflydream/mnh-tool-goal'
import * as ToolSchedule from '@aflydream/mnh-schedule'
import Lsp from '@aflydream/mnh-lsp'
import * as ToolLsp from '@aflydream/mnh-tool-lsp'
import * as ToolSkill from '@aflydream/mnh-tool-skill'
import * as ToolSessionQuery from '@aflydream/mnh-tool-session-query'
import * as ToolTasks from '@aflydream/mnh-tool-jobs'
import * as ToolTodo from '@aflydream/mnh-tool-todo'
import * as ToolSubagent from '@aflydream/mnh-tool-subagent'
import * as ToolWeb from '@aflydream/mnh-tool-web'
import VmWorkflowEngine from '@aflydream/mnh-workflow-worker-thread'
import * as ToolRalph from '@aflydream/mnh-tool-ralph'
import * as ToolWorkflow from '@aflydream/mnh-tool-workflow'
...
const OUT = 'AgentGuide/reference/tool-catalog.md'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@aflydream/mnh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  },
  {
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@aflydream/mnh-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@aflydream/mnh-tool-pwsh',
    dir: 'tool-pwsh',
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@aflydream/mnh-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `MNH_*` environment comes from `@aflydream/mnh-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@aflydream/mnh-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see AgentGuide/architecture.md). The toolset injects `ctx.dynamicCordisRunner` from `@aflydream/mnh-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or MNH restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@aflydream/mnh-tool-bash-persistent',
  ...
  {
    pkg: '@aflydream/mnh-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@aflydream/mnh-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. `read_image` is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@aflydream/mnh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@aflydream/mnh-tool-terminal',
    dir: 'tool-terminal',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@aflydream/mnh-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@aflydream/mnh-tool-ralph',
    dir: 'tool-ralph',
  ...
  },
  {
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        mnhHome: resolve(root, '.tmp/tool-catalog/.mnh'),
  ...
  {
    pkg: '@aflydream/mnh-tool-session-query',
  ...
  {
    pkg: '@aflydream/mnh-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@aflydream/mnh-tool-subagent-control',
  ...
  {
    pkg: '@aflydream/mnh-tool-subagent-report',
  ...
  {
    pkg: '@aflydream/mnh-tool-workflow',
    dir: 'tool-workflow',
