...
function checkManifest(
  ...
  if (owner.packageName === '@aflydream/mnh-invariants') return
  if (manifest.peerDependencies?.['@aflydream/mnh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@aflydream/mnh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@aflydream/mnh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@aflydream/mnh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@aflydream/mnh-invariants'
