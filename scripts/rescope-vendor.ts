 ...
 * [name mapping](../AgentGuide/reference/rescope.md)).
 *
 ...
 * `@aflydream/mnh-tool-cordis`, and `cordiverse/cordis`, and makes the
...
function excluded(file: string): boolean {
  ...
  if (file === 'AgentGuide/reference/rescope.md' || file === 'AgentGuide/reference/rescope.zh.md') return true
