...
export function renderPairMeta(source: string, sourceHash: string, zh: string, zhHash: string): string {
  return [
    '# Bilingual-pair consistency record (AgentGuide/reference/i18n/README.md): the git blob hash of each',
...
const PUBLIC_REPOSITORY_BLOB_ROOT = 'https://github.com/aflydream/mineko-herness/blob/master/'
...
export function requiresSourceLanguageSwitcher(source: string): boolean {
  return ![
    'AgentGuide/reference/agent-lifecycle.md',
    'AgentGuide/reference/capability-seams.md',
    'AgentGuide/reference/config-catalog.md',
    'AgentGuide/reference/cordis-api/context.md',
    'AgentGuide/reference/cordis-api/events.md',
    'AgentGuide/reference/cordis-api/fiber.md',
    // Excluded from pairing, but kept here for generated-category completeness and direct spec coverage.
    'AgentGuide/reference/cordis-api/inherited.md',
    'AgentGuide/reference/cordis-api/registry.md',
    'AgentGuide/reference/cordis-api/service.md',
    'AgentGuide/reference/event-producer-consumer.md',
    'AgentGuide/reference/graph-atlas.md',
    'AgentGuide/reference/module-graph.md',
    'AgentGuide/reference/persistence-catalog.md',
    'AgentGuide/reference/tool-catalog.md',
    'AgentGuide/reference/tool-execution-pipeline.md',
  ].includes(source)
}
