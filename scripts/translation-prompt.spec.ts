...
const document = readFileSync(join(root, 'AgentGuide/reference/i18n/translation-prompt.md'), 'utf8')
...
const retainedExamples = [
  ...
  ['### Run-on sentence → Natural phrasing with pause', 'Read AgentGuide/reference/architecture.md before changing anything under packages/.', '在修改 packages/ 目录下的任何内容之前，请先阅读 AgentGuide/reference/architecture.md。'],
  ...
  ['### Slang/jargon → Professional phrasing', 'The committed agent workflow lives in .agents/skills/mnh-translate-docs', '仓库内置的 agent 工作流见 .agents/skills/mnh-translate-docs'],
